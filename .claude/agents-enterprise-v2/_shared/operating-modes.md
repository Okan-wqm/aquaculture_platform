...
**Audience:** every enterprise-v2 agent file includes this fragment via `@.claude/agents-enterprise-v2/_shared/operating-modes.md`. Override at the bottom only if the agent has domain-specific mode behaviour (e.g., context-manager has no WRITER mode).
...
- `.claude/agents-enterprise-v2/_shared/tier-claim-syntax.md` — inline tier / override grammar
- `.claude/agents-enterprise-v2/_shared/handoff-protocol.md` — skill ↔ agent handoff contract
- `.claude/agents-enterprise-v2/_shared/output-format.md` — finding report skeleton
