          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="px-6 py-4 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Tahmini Süre (dk)</label>
                  <input
                    type="number"
              ...
              <div>
                ...
                {formData.checklistItems.map(item => (
                  <div key={item.id} className="flex items-center gap-2 mb-1">
                    <span className="flex-1 text-sm text-gray-700 bg-gray-50 px-3 py-1.5 rounded">{item.text}</span>
                    <button
                      type="button"
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1 mb-2">
                  {formData.tags.map(tag => (
                    <span key={tag} className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-xs bg-gray-100 text-gray-700">
                      {tag}
