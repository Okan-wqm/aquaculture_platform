...
| `sentinel_hub_settings` | Satellite imagery API configuration. |

#### Weather & Marine

| Table | Purpose |
|-------|---------|
| `weather_observations` | Weather data records. |
| `marine_observations` | Marine/oceanographic data records. |
| `weather_settings` | Weather API configuration. |
...
## Separate Databases (Out of Scope)
