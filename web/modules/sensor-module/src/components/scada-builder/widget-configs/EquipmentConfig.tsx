...
export const EquipmentConfig: React.FC<WidgetConfigProps> = ({ config, onChange, deviceId }) => {
  ...
  return (
    <div className="space-y-3">
      ...
      <div>
        <label className="block text-xs text-gray-500 dark:text-gray-400 mb-1">Equipment Type</label>
      ...
      <div>
        ...
        <Input fullWidth type="text" value={config.label || ''} onChange={(e) => onChange({ label: e.target.value })} placeholder="Equipment label" />
      </div>
