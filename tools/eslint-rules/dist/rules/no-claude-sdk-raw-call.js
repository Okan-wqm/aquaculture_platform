...
exports.default = createRule({
    ...
    meta: {
        type: 'problem',
        docs: {
            description: 'Direct `@anthropic-ai/sdk` imports outside the designated wrapper bypass the AI safety pipeline (rate limit, token budget, content guardrails, audit, cost attribution) — ai-safety-auditor CRITICAL class.',
        },
        schema: [],
        messages: {
    ...
    create(context) {
        ...
        if (WRAPPER_PATH_SUFFIXES.some((suffix) => filename.endsWith(suffix)))
            return {};
...
//# sourceMappingURL=no-claude-sdk-raw-call.js.map