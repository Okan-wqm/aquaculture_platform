...
export const tr: Record<MessageKey, string> = {
  ...
  'feeding.errors.amountRequired': 'Miktar en az {minimumKg} kg olmalı',
  'feeding.errors.amountMax': 'Miktar {maximumKg} kg üzerinde olamaz',
  'feeding.errors.amountPrecision': 'Miktar {stepKg} kg artımlarıyla girilmeli',
