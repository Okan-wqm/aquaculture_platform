...
`agent-v2.0.0-rc4` publishes a hardened release contract and `scada-display` binary tier. It does not claim dispatcher-level RBAC enforcement; this manifest remains the vocabulary for the follow-up runtime PR.
