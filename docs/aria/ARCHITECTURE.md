...
Astra/ultra is explicit on the native OpenAI route, without changing legacy fleet default. Zero eligible stays pending/requeue; Claude/Z.ai live routes are not qualified by current Codex evidence.
