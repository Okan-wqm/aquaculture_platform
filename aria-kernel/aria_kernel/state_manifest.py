...
STATE_SURFACES: tuple[StateSurface, ...] = (
    ...
    StateSurface("agent_eval_fixtures", "agent-evals/fixtures/*.json", "artifact", "agent_evals", "runtime", True, "rewrite_fsync", True, profile_surface="agent_evals", observe_class="action"),
