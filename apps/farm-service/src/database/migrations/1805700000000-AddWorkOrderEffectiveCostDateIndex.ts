 ...
 */
export class AddWorkOrderEffectiveCostDateIndex1805700000000 implements MigrationInterface {
  name = 'AddWorkOrderEffectiveCostDateIndex1805700000000';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX IF EXISTS "idx_work_orders_tenant_effective_cost_date"`);
  }
}
