...
See `@.claude/agents-enterprise-v2/_shared/operating-modes.md`. CATCHER default; TEACHER outputs the breaker config + fail-mode for the specific operation. WRITER mode NOT supported.
