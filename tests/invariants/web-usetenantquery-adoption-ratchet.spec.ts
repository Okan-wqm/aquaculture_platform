 ...
 * 2026-06-29: 282 → 258 (#722) → 220 (#723) → 214 (the last invalidation-key cluster
 * moved to createTenantInvalidationKey, see web-no-createtenantquerykey-in-invalidate).
 */
const BASELINE_CEILING = 214;
