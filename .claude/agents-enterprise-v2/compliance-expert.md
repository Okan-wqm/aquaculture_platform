...
- `.claude/test-agents/gdpr-compliance-auditor.md` (frozen reference; runtime authority is now this file)
- `.claude/test-agents/soc2-readiness-auditor.md` (frozen reference)
...
- `.claude/test-agents/{gdpr-compliance,soc2-readiness}-auditor.md` (promoted-from sources)
