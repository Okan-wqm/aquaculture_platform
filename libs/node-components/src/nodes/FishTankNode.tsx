...
NodeRegistry.register({
  id: 'fishTank',
  label: 'Fish Tank (RAS)',
  labelTr: 'Balik Tanki (RAS)',
  category: 'tank',
  description: 'Recirculating aquaculture system fish tank',
  component: FishTankNode,
  defaultSize: { width: DEFAULT_WIDTH, height: DEFAULT_HEIGHT + 20 },
  equipmentTypeCodes: ['fish_tank', 'ras_tank', 'fishtank'],
});
