...
## ORPHAN-MEDIUM-296 — ARIA has no scheduled cycle producer; the executor cron drains an always-empty queue — IN-PROGRESS
...
## ORPHAN-MEDIUM-297 — proven-drift seed pool was stale worktree pollution; no tool derives aria-findings from repo truth — IN-PROGRESS
