    ...
    >
      {step === 'form' ? (
                ...
                {existingKeys.map((key) => (
                  ...
                  >
                    <div>
                      ...
                      <span
                        className={`ml-2 px-1.5 py-0.5 rounded-full ${key.isActive ? 'bg-emerald-100 text-emerald-700' : 'bg-red-100 text-red-700'}`}
                      >
        ...
        <div className="p-6 space-y-4">
          {/* Installer Command */}
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Kurulum Komutu</label>
