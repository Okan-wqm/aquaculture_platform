    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
          ...
          <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-4">{metrics.totalReadings}</p>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
          ...
          <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-4">{metrics.avgDataRate}</p>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
          ...
          <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-4">{metrics.uptime}</p>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
          ...
          <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-4">{metrics.alertsThisMonth}</p>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
          ...
          <div className="space-y-4">
            {sensorTypeStats.map((stat) => (
              <div key={stat.type} className="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-700 last:border-0">
                <div className="flex items-center gap-3">
                  <span className="font-medium text-gray-900 dark:text-gray-100">{stat.type}</span>
                  <span className="text-sm text-gray-500 dark:text-gray-400">({stat.count} sensör)</span>
                </div>
                <div className="flex items-center gap-4 text-sm">
                  <span className="text-gray-600 dark:text-gray-400">{stat.readings} okuma</span>
                  <span className={`${stat.alerts > 10 ? 'text-yellow-600' : 'text-gray-500 dark:text-gray-400'}`}>
                    {stat.alerts} uyarı
                  </span>
                </div>
              </div>
            ...
            {locationStats.map((location) => (
              <div key={location.location}>
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    <span className="font-medium text-gray-900 dark:text-gray-100">{location.location}</span>
                    <span className="text-sm text-gray-500 dark:text-gray-400">({location.sensors} sensör)</span>
                  </div>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
        ...
        <div className="h-64 bg-gray-50 dark:bg-gray-800 rounded-lg border-2 border-dashed border-gray-200 dark:border-gray-700 flex items-center justify-center">
          <p className="text-gray-500 dark:text-gray-400">Trend grafiği (Recharts) entegre edilecek</p>
        </div>
      </div>
