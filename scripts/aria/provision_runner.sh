...
for probe in "${SERVICE_NAME}|OOMPolicy|continue" "${SERVICE_NAME}|MemoryMax|8589934592" "${SERVICE_NAME}|CPUWeight|400" "user-.slice|MemoryMax|3221225472" "user.slice|CPUWeight|50"; do
