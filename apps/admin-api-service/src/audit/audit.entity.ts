...
export enum AuditAction {
  ...
  DATABASE_EXPLORER_INSERT_INTENT = 'DATABASE_EXPLORER_INSERT_INTENT',
  DATABASE_EXPLORER_UPDATE_INTENT = 'DATABASE_EXPLORER_UPDATE_INTENT',
  DATABASE_EXPLORER_DELETE_INTENT = 'DATABASE_EXPLORER_DELETE_INTENT',
