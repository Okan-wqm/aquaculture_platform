...
export class DiscountCodeService {
  ...
  async findAll(options?: {
    ...
    return createStandardPaginatedResult(data.map(toCodeResponse), total, page, limit);
  }
  ...
  async getRedemptions(
    ...
    return createStandardPaginatedResult(data.map(toRedemptionResponse), total, page, limit);
  }
  ...
  async deactivate(discountCodeId: string, actorId: string): Promise<DiscountCodeResponseDto> {
