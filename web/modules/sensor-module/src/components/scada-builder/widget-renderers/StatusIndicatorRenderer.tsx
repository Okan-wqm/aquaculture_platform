...
const StatusIndicatorRenderer: React.FC<WidgetRendererProps> = ({
  config,
  value,
  width,
  height,
  ...
  return (
    ...
    >
      <svg width={svgSize} height={svgSize}>
        ...
        {/* Main circle */}
        <circle cx={cx} cy={cy} r={circleR} fill={color} style={{ transition: 'fill 0.4s ease' }} />
      ...
      <span
        style={{ fontSize: 11, fontWeight: 500, color: colors.neutral[700], textAlign: 'center' }}
      >
        {label}
      </span>
    </div>
