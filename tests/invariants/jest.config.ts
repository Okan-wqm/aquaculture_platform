  ...
  projects: [
    {
      ...
      testMatch: [
        ...
        '<rootDir>/automation-publication-authority.spec.ts',
        '<rootDir>/capability-integration-evidence-contract.spec.ts',
        '<rootDir>/capability-source-inventory-contract.spec.ts',
        '<rootDir>/source-finding-inventory-contract.spec.ts',
