...
### ADMIN-RC-GAP-01 — RC-2/3/4/6 request-contract slice not re-derived
...
### ADMIN-RC-GAP-02 — support silo consolidation not re-derived
...
### ADMIN-RC-GAP-03 — admin-api still configures no NATS microservice transport
...
### ADMIN-RC-GAP-04 — analytics still reports fabricated numbers
...
### ADMIN-RC-GAP-05 — DB-explorer mask asymmetry, audit attribution and write capability
...
### ADMIN-RC-GAP-06 — the ADMIN registry sequence band 003–085 is claimed by a document, not the ledger
...
### ADMIN-RC-GAP-07 — none of the chain's ten admin-api migrations are ported
