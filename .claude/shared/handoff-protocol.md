...
- `prompt-writer` — maintenance agent for `.claude/agents/` and `.claude/skills/` content. Not in the runtime review roster (per `orchestrator.md:13-19` strict review-only policy).
...
- `.claude/agents/orchestrator.md` — routing table + phase flow
- `.claude/shared/operating-modes.md` — mode-switching rules including pair-review invariant
