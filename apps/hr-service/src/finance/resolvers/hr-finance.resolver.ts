...
export class HrFinanceResolver {
  ...
  @Roles(Role.TENANT_ADMIN, Role.MODULE_MANAGER)
  @AuditLog({
    action: 'CREATE_HR_FINANCE_ENTRY',
    resource: 'HrFinanceEntry',
    description: 'Book an HR finance entry',
  })
  ...
  @Roles(Role.TENANT_ADMIN, Role.MODULE_MANAGER)
  @AuditLog({
    action: 'UPDATE_HR_FINANCE_ENTRY',
    resource: 'HrFinanceEntry',
    description: 'Update an HR finance entry',
  })
  ...
  @Roles(Role.TENANT_ADMIN, Role.MODULE_MANAGER)
  @AuditLog({
    action: 'DELETE_HR_FINANCE_ENTRY',
    resource: 'HrFinanceEntry',
    description: 'Soft-delete an HR finance entry',
  })
  ...
  @Roles(Role.TENANT_ADMIN, Role.MODULE_MANAGER)
  @AuditLog({
    action: 'CREATE_HR_FINANCE_CATEGORY',
    resource: 'HrFinanceCategory',
    description: 'Create an HR finance category',
  })
  ...
  @Roles(Role.TENANT_ADMIN, Role.MODULE_MANAGER)
  @AuditLog({
    action: 'UPDATE_HR_FINANCE_CATEGORY',
    resource: 'HrFinanceCategory',
    description: 'Update an HR finance category',
  })
  ...
  @AuditLog({
    action: 'ARCHIVE_HR_FINANCE_CATEGORY',
    resource: 'HrFinanceCategory',
    description: 'Archive an HR finance category',
  })
  ...
  @Roles(Role.TENANT_ADMIN)
  @AuditLog({
    action: 'RESTORE_HR_FINANCE_CATEGORY',
    resource: 'HrFinanceCategory',
    description: 'Restore an HR finance category',
  })
  ...
  @Roles(Role.TENANT_ADMIN)
  @AuditLog({
    action: 'UPDATE_PAYROLL_COST_SETTINGS',
    resource: 'PayrollCostSettings',
    description: 'Update payroll cost settings',
  })
