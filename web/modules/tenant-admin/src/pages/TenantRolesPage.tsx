      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto">
          <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">Higher = more authority (1-100)</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-4 bg-yellow-50 rounded-xl border border-yellow-100">
              ...
              <label htmlFor="isDefault" className="flex-1">
                <span className="text-sm font-medium text-gray-900">Set as default role</span>
            ...
            <div>
              ...
              {categories.length > 0 ? (
                ...
                <div className="p-8 text-center bg-gray-50 rounded-xl">
                  ...
                  <p className="mt-2 text-sm text-gray-500">Loading permission categories...</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="px-6 py-4 border-t border-gray-100 bg-gray-50 flex items-center justify-between">
            {role?.isSystem && (
              <p className="text-xs text-amber-600">System roles cannot be modified</p>
            )}
    ...
    <div className="space-y-6">
      ...
      {roles.length > 0 ? (
        ...
        <div className="bg-white rounded-xl border border-gray-100 py-16 text-center">
          ...
          <h3 className="mt-4 text-lg font-semibold text-gray-900">No roles defined</h3>
