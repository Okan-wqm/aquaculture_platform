 ...
 * bound at all. `MoveCustomPlans1802600000000` copied the rows into
 ...
 */
export class RetireAdminCustomPlans1809500000000 implements MigrationInterface {
  name = 'RetireAdminCustomPlans1809500000000';
    ...
    await queryRunner.query(`
      ...
      BEGIN
        ...
        IF to_regclass('billing.custom_plans') IS NULL THEN
          RAISE EXCEPTION
            'billing.custom_plans does not exist — run the billing migrations (MoveCustomPlans1802600000000) before retiring the admin table';
        END IF;
