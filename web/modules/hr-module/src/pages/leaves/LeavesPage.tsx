...
export function LeavesPage() {
  ...
  const { data: pendingApprovals, isLoading: loadingPending } =
    usePendingLeaveApprovals(employeeId);
    ...
    <div className="space-y-6 p-6">
      ...
      {rejectingId && (
        <Modal
          ...
          footer={
            <>
              <Button variant="ghost" type="button" onClick={closeRejectModal}>
                Cancel
              </Button>
              <Button
                variant="danger"
              ...
              >
                {rejectMutation.isPending && <Spinner size="sm" color="white" />}
                Confirm Rejection
              </Button>
            </>
          }
