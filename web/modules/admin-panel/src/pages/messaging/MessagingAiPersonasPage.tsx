...
const actuationPolicyColumns: DataTableColumn<ActuationPolicyField>[] = [
  {
    key: 'field',
    header: 'Field',
    render: (_value, row) => <span className="font-mono text-gray-700">{row.field}</span>,
  },
  {
    key: 'type',
    header: 'Type',
    render: (_value, row) => <span className="text-gray-500">{row.type}</span>,
  },
  {
    key: 'description',
    header: 'Description',
    render: (_value, row) => <span className="text-gray-600">{row.description}</span>,
  },
  {
    key: 'impact',
