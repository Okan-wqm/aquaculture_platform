      ...
      <div className="flex items-center justify-between px-4 py-3 pt-safe-top bg-black/60 backdrop-blur-sm z-10">
        ...
        {currentMedia && (
          <div className="flex-1 text-center min-w-0 px-2">
            <p className="text-sm font-medium text-white truncate">{currentMedia.senderName}</p>
            <p className="text-[11px] text-white/75">{formatMediaDate(currentMedia.sentAt)}</p>
          </div>
        )}
