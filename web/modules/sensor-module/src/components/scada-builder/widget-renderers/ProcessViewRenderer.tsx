    ...
    >
      ...
      >
        ...
        <svg width="100%" height={Math.min((height - 16) * 0.4, 80)} viewBox="0 0 200 80" preserveAspectRatio="xMidYMid meet">
          {/* Tanks */}
          <rect x={10} y={20} width={40} height={50} rx={4} fill={colors.primary[100]} stroke={colors.info[500]} strokeWidth={1.5} />
          <rect x={80} y={10} width={40} height={60} rx={4} fill={colors.secondary[100]} stroke={colors.success[500]} strokeWidth={1.5} />
          <rect x={150} y={25} width={40} height={45} rx={4} fill={colors.primary[100]} stroke={colors.info[500]} strokeWidth={1.5} />
          {/* Pipes */}
        ...
        <span style={{ fontSize: 12, fontWeight: 600, color: colors.primary[700] }}>{processName}</span>
