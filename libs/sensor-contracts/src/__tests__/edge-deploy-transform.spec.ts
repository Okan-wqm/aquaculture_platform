    ...
    const input = doc({
      screens: [
        ...
        },
        {
          ...
          name: 'Drives',
          widgets: [
            { id: 'w3', widgetType: 'vfdDrive', position: { col: 0, row: 0, w: 2, h: 2 }, config: {} },
          ],
        },
      ],
    });
      ...
      screens: [
        {
          ...
          widgets: [
            ...
            { id: 'w2', widgetType: 'staticText', position: { col: 1, row: 0, w: 1, h: 1 }, config: { text: 'hi' } },
            { id: 'w3', widgetType: 'svgCircle', position: { col: 2, row: 0, w: 1, h: 1 }, config: {} },
          ],
        },
      ],
    });
  ...
  it('fills the fields the Rust structs require: screen name/screenType, alarm severity/message', () => {
    ...
    const input: ScadaPackageDocV2 = {
      ...
      alarmRules: [
        ...
        { id: 'a2', tag: 'do', condition: 'lt', value: 4, severity: 'fatal', message: 'DO critical' },
      ],
    };
    const result = transformScadaDocForEdgeDeploy(input);
    expect(result.ok).toBe(true);
      ...
      screens: [
        {
          ...
          widgets: [
            { id: 'w1', widgetType: 'gauge', position: { col: 0, row: 0, w: 1, h: 1 }, config: {} },
            { id: 'w2', widgetType: 'staticText', position: { col: 1, row: 0, w: 1, h: 1 }, config: {} },
          ],
        },
      ],
