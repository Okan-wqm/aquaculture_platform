  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // ── LEGACY palettes ───────────────────────────────────────────────
        // Still referenced by pages not yet migrated to the tokens above.
        // The ratchet in src/__tests__/design-token.invariant.spec.ts drives
        // these to zero; delete this block when it gets there.
