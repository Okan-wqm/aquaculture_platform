...
Status: RESOLVED for slice 6 renames (5; 69→64) + the backend-op DECISION delivered. Tracked: ~16 REMOVE-FE (clean next slice) + ~43 IMPLEMENT-BACKEND (roadmap, UpdateShift first). Registry: orphan-findings.md + graphql-fe-drift.baseline.json.
