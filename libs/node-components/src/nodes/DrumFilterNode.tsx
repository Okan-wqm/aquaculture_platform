...
const DrumFilterNode: React.FC<NodeProps<Node<DrumFilterNodeData>>> = ({ id, data, selected }) => {
  ...
  return (
    ...
    >
      <svg width={WIDTH} height={HEIGHT} viewBox="60 105 812 315" xmlns="http://www.w3.org/2000/svg" style={{ pointerEvents: 'auto' }}>
      ...
      {/* Handles */}
      <div style={{ position: 'absolute', left: 6, top: 48, width: 12, height: 12, transform: 'translate(-50%, -50%)', pointerEvents: 'all' }} onContextMenu={toggleHandler(inletType1, setInletType1, 'inletType1')}>
      ...
      <div style={{ position: 'absolute', left: 6, top: 57, width: 12, height: 12, transform: 'translate(-50%, -50%)', pointerEvents: 'all' }} onContextMenu={toggleHandler(inletType2, setInletType2, 'inletType2')}>
      ...
      <div style={{ position: 'absolute', left: 6, top: 67, width: 12, height: 12, transform: 'translate(-50%, -50%)', pointerEvents: 'all' }} onContextMenu={toggleHandler(inletType3, setInletType3, 'inletType3')}>
      ...
      <div style={{ position: 'absolute', left: 8, top: 31, width: 12, height: 12, transform: 'translate(-50%, -50%)', pointerEvents: 'all' }} onContextMenu={toggleHandler(drainType, setDrainType, 'drainType')}>
      ...
      <div style={{ position: 'absolute', left: 154, top: 55, width: 12, height: 12, transform: 'translate(-50%, -50%)', pointerEvents: 'all' }} onContextMenu={toggleHandler(outlet, setOutlet, 'outlet')}>
