 ...
 * billing by `CreateModulePriceSheet1802400000000`, which `SCHEMA_REGISTRY`
 ...
 */
export class RetireAdminModulePricing1809300000000 implements MigrationInterface {
  name = 'RetireAdminModulePricing1809300000000';
    ...
    await queryRunner.query(`
      ...
      BEGIN
        ...
        IF to_regclass('billing.module_prices') IS NULL THEN
          RAISE EXCEPTION
            'billing.module_prices does not exist — run the billing migrations (CreateModulePriceSheet1802400000000) before retiring the admin price sheet';
        END IF;
