...
`AUDIT-{SEVERITY}-{NNN}` — e.g., `AUDIT-CRITICAL-001`, `AUDIT-HIGH-007`, `AUDIT-MEDIUM-012`. Zero-padded sequential within one cycle. Severity ∈ {CRITICAL, HIGH, MEDIUM, LOW}. See `@.claude/agents-enterprise-v2/_shared/output-format.md`.
