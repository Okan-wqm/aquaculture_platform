...
These prompts are inert until you point your orchestration flow at `.claude/agents/` or selectively promote individual files. Existing `.claude/agents/` prompts were not modified.
