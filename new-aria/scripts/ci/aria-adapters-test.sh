...
for pack_test in packs/legal/adapters/legal-document-inventory.test.ts packs/legal/adapters/binary/extract.test.ts packs/legal/adapters/records/statement-gate.test.ts packs/legal/adapters/records/fact-index.test.ts packs/legal/adapters/records/version-diff.test.ts packs/legal/adapters/records/party-candidates.test.ts packs/legal/adapters/records/deadlines.test.ts packs/legal/adapters/records/roles.test.ts packs/legal/adapters/records/precision.test.ts; do
