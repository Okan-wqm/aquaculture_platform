...
describe('SuperAdmin-TenantAdmin Support Ticket Integration', () => {
  ...
  describe('Full Support Ticket Flow', () => {
    it('should complete a full support ticket lifecycle', async () => {
      ...
      // WHY: addComment/getComments resolve the caller twice (own guard +
      // getTicket access check). Per-step mockResolvedValueOnce chains
      // desynchronise from the real lookup count — resolve by id as the base
