...
## ORPHAN-MEDIUM-313 — aquamobil: 10 of ~65 void-wrapped async calls were genuinely unguarded (2 broke their own "never throws" contract) — IN-PROGRESS
...
## ORPHAN-HIGH-310 — ARIA plan convergence measures agreement, not coverage; the impact closure was never kernel-verified — IN-PROGRESS
