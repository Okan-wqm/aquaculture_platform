...
> = {
  ...
  `,
  clockIn: `
    mutation ClockIn($input: ClockInPayload!) {
      clockIn(input: $input) {
        id
        date
        clockIn
  ...
  `,
  clockOut: `
    mutation ClockOut($input: ClockOutPayload!) {
  ...
  `,
  createLeaveRequest: `
    mutation CreateLeaveRequest($input: CreateLeaveRequestPayload!) {
...
checklistItems {
  ...
  sendMessage: `
    mutation SendMessage($input: SendMessagePayload!) {
