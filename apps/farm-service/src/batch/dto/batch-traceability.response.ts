...
export class BatchFeedTotalResponse implements BatchFeedTotal {
  ...
  @Field(() => Float, { nullable: true, deprecationReason: 'Use totalCostDecimal (exact decimal string, ADR-0004).' }) totalCost?: number;
}
...
export class BatchTraceabilitySummaryResponse implements BatchTraceabilitySummary {
  ...
  @Field(() => Float, { nullable: true, deprecationReason: 'Use totalFeedCostDecimal (exact decimal string, ADR-0004).' }) totalFeedCost?: number;
