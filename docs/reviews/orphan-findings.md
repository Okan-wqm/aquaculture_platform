...
## ORPHAN-MEDIUM-313 — plan-coverage PR-1 staged loosening: waivers machine-accepted on any non-empty reason — IN-PROGRESS
...
## ORPHAN-LOW-314 — challenger independence was read-order-only; correlated blindness unaddressed — IN-PROGRESS
