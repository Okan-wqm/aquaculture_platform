...
export interface Message {
  ...
  /**
   * FAZ 2 server-authoritative AI stamp — set by the backend when the message
   * was generated by the AI virtual user. Optional because legacy socket
   * envelopes may predate it; AI detection treats absence as "not stamped"
   * and falls back to the senderId === AI_USER_ID check. NEVER trust
   * `metadata.isAi` for this — that key is user-forgeable client input.
   */
