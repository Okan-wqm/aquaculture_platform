...
export class Baseline1800000000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "auth"."audit_logs_severity_enum" AS ENUM('info', 'warning', 'error', 'critical')`);
        ...
        await queryRunner.query(`CREATE TYPE "auth"."support_tickets_category_enum" AS ENUM('technical', 'billing', 'feature_request', 'bug', 'general')`);
        await queryRunner.query(`CREATE TYPE "auth"."support_tickets_priority_enum" AS ENUM('critical', 'high', 'medium', 'low')`);
        await queryRunner.query(`CREATE TYPE "auth"."support_tickets_status_enum" AS ENUM('open', 'in_progress', 'waiting_customer', 'resolved', 'closed')`);
        ...
        await queryRunner.query(`CREATE TYPE "auth"."ticket_comments_authortype_enum" AS ENUM('super_admin', 'tenant_admin', 'system')`);
        ...
        await queryRunner.query(`CREATE TYPE "auth"."message_threads_status_enum" AS ENUM('open', 'closed', 'archived')`);
        ...
        await queryRunner.query(`CREATE TYPE "auth"."messages_sendertype_enum" AS ENUM('super_admin', 'tenant_admin', 'system')`);
        await queryRunner.query(`CREATE TYPE "auth"."messages_status_enum" AS ENUM('sent', 'delivered', 'read')`);
        ...
        await queryRunner.query(`CREATE TYPE "auth"."announcements_type_enum" AS ENUM('info', 'warning', 'critical', 'maintenance')`);
        await queryRunner.query(`CREATE TYPE "auth"."announcements_status_enum" AS ENUM('draft', 'scheduled', 'published', 'expired', 'cancelled')`);
        await queryRunner.query(`CREATE TYPE "auth"."announcements_scope_enum" AS ENUM('platform', 'tenant')`);
