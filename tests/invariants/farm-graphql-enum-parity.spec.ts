...
const ENUM_PARITY: readonly EnumParityPair[] = [
  {
    ...
    backend: { file: `${BE}/entities/regulatory-report-draft.entity.ts`, enumName: 'ReportDraftStatus' },
  ...
  },
  {
    ...
    backend: { file: `${BE}/entities/regulatory-report.entity.ts`, enumName: 'RegulatoryReportType' },
    frontend: { file: `${FE}/hooks/useRegulatoryReports.ts`, typeName: 'RegulatoryReportTypeValue' },
  },
  {
    label: 'WelfareEventTypeInput (welfare varsling event type)',
    backend: { file: `${BE}/dto/regulatory-varsling-inputs.dto.ts`, enumName: 'WelfareEventTypeInput' },
  ...
  },
  {
    ...
    backend: { file: `${BE}/dto/regulatory-varsling-inputs.dto.ts`, enumName: 'WelfareSeverityInput' },
  ...
  },
  {
    ...
    backend: { file: `${BE}/dto/regulatory-varsling-inputs.dto.ts`, enumName: 'DiseaseCategoryInput' },
  ...
  },
  {
    ...
    backend: { file: `${BE}/dto/regulatory-varsling-inputs.dto.ts`, enumName: 'DiseaseConfirmationInput' },
