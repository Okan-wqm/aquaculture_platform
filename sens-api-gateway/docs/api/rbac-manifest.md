...
`agent-v2.0.0-rc2` publishes a hardened release contract and `edge-rc2` binary profile. It does not claim dispatcher-level RBAC enforcement; this manifest remains the vocabulary for the follow-up runtime PR.
