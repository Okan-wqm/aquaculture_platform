...
export const WorkersTab: React.FC = () => {
  ...
  const filtered = workerList.filter(item => {
    ...
    return fullName.includes(search) || item.email.toLowerCase().includes(search) || item.position.toLowerCase().includes(search);
  });
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-start justify-center min-h-screen px-4 pt-4 pb-20">
            ...
            <div className="relative bg-white rounded-lg shadow-xl sm:max-w-lg sm:w-full sm:my-8">
