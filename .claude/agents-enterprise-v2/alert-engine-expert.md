...
- `.claude/agents-enterprise-v2/sensor-expert.md` — sensor event contract
- `.claude/agents-enterprise-v2/edge-expert.md` — IEC 62443 FR 6 timely response + local alarm
