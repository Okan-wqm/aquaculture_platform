...
| **W6 — physical types**                   | ADMIN-HIGH-012 (timestamptz + uuid landed; inet, arrays, money remain) → ADMIN-MEDIUM-016                                                           | the type is the cheapest constraint; the decorator is what a baseline squash reads                                                                                      |
