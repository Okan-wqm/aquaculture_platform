/**
 * INVARIANT — the impersonation aggregate has one owner, and its field names
 * say which period each number covers.
 *
 * # What was there
 *
 ...
 *
 * @see docs/reviews/claude/2026-07-20-admin-panel-e2e-audit/findings/impersonation-debug.md
 */
...
describe('INVARIANT: impersonation audit-summary contract', () => {
  it('the frontend mirror carries exactly the fields the backend sends', () => {
    ...
    const frontend = interfaceFields(FRONTEND_TYPES, 'ImpersonationAuditSummary', 'admin-panel');
