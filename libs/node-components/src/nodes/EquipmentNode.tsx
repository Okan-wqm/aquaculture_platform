...
export const EquipmentNode = memo(({ id, data, selected }: NodeProps<EquipmentNodeData>) => {
  ...
  const handleToggleConnectionPoint = useCallback(
    ...
    [id, connectionPoints, setNodes, isScadaMode]
  );
...
NodeRegistry.register({
  ...
  labelTr: 'Ekipman',
  category: 'equipment',
  description: 'Generic equipment node with multiple types',
  component: EquipmentNode,
  defaultSize: { width: 140, height: 120 },
  equipmentTypeCodes: ['equipment', 'generic'],
});
