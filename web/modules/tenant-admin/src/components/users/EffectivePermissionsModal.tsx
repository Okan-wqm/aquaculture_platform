                      ...
                      <ul className="divide-y divide-gray-50">
                        {Object.entries(categoryPermissions).map(([resourceName, actions]) => {
                          const enabledActions = Object.entries(actions)
                            ...
                            .map(([action]) => action);
                          return (
                            <li key={resourceName} className="px-3 py-2 flex items-start justify-between gap-3">
                ...
                <div className="space-y-3">
                  ...
                  {grants.length > 0 && (
                    <div className="p-3 bg-green-50 border border-green-100 rounded-lg">
                      <p className="text-xs font-medium text-green-800 mb-1">Granted in addition to the role</p>
                    ...
                    <div className="p-3 bg-red-50 border border-red-100 rounded-lg">
                      ...
                      <ul className="space-y-0.5">
                        {revokes.map((permission) => (
                          <li key={permission} className="text-sm text-red-700 flex items-center gap-2">
