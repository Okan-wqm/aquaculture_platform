  ...
  return (
    ...
    >
      <g transform={`rotate(${rotation || 0} 50 40)`}>
        {/* Pipe stubs */}
        <line x1={0} y1={40} x2={20} y2={40} stroke={chartChrome.axis} strokeWidth={3} strokeLinecap="round" />
        <line x1={80} y1={40} x2={100} y2={40} stroke={chartChrome.axis} strokeWidth={3} strokeLinecap="round" />
        ...
        {label && (
          <text x={50} y={75} textAnchor="middle" fontSize={9} fill={themeColors.neutral[700]} fontFamily="sans-serif">
            {label}
          </text>
        )}
      </g>
