/**
 * UpdateParameterConfig Input DTO
 */
...
export class UpdateParameterConfigInput {
  ...
  @Field(() => ParameterDataType, { nullable: true, description: 'Value data type' })
  @IsOptional()
  @IsEnum(ParameterDataType)
  dataType?: ParameterDataType;

  @Field(() => Int, { nullable: true, description: 'Decimal places' })
  @IsOptional()
  @IsInt()
  @Min(0)
  @Max(6)
  ...
  @Field(() => ParameterGroup, { nullable: true, description: 'Parameter group' })
  @IsOptional()
  ...
  @Field(() => Int, { nullable: true, description: 'Display ordering' })
  @IsOptional()
  @IsInt()
  @Min(0)
  displayOrder?: number;

  @Field({ nullable: true, description: 'Visible in UI' })
  @IsOptional()
  @IsBoolean()
  isVisible?: boolean;

  @Field({ nullable: true, description: 'Required during measurement entry' })
  @IsOptional()
  @IsBoolean()
  isRequired?: boolean;

  @Field({ nullable: true, description: 'Active and available' })
  @IsOptional()
  @IsBoolean()
  isActive?: boolean;

  @Field({ nullable: true, description: 'Chart Y-axis group' })
  @IsOptional()
  @IsString()
  @MaxLength(20)
  chartAxisGroup?: string;

  @Field({ nullable: true, description: 'Show in quick-access panel' })
  @IsOptional()
  @IsBoolean()
