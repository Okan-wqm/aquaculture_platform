...
export const StrokeConfig: React.FC<StrokeConfigProps> = ({
  ...
  <div className="space-y-3">
    ...
    {/* Line cap */}
    <div>
      <label className="block text-xs text-gray-500 dark:text-gray-400 mb-1">Line Cap</label>
    ...
    {/* Line join */}
    <div>
      <label className="block text-xs text-gray-500 dark:text-gray-400 mb-1">Line Join</label>
