      ...
      <div className="flex items-center justify-center min-h-screen px-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl max-w-2xl w-full p-6 z-10">
          ...
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-medium text-gray-900">Apply Parameter Template</h3>
          ...
          <div className="mb-4 bg-amber-50 border border-amber-200 rounded-lg p-3">
            <div className="flex">
              ...
              <p className="text-sm text-amber-800">
                This will configure your water quality parameters. Existing parameters can be kept or replaced.
              </p>
            </div>
          </div>
