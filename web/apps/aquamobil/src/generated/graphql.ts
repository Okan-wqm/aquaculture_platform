...
export type FarmDashboardInsightsQuery = {
...
export type TankRiskAssessmentQuery = {
  tankRiskAssessment: {
    tankId: string;
    riskScore: number;
    riskLevel: string;
...
export type BatchGrowthPredictionQuery = {
...
export type FeedingAdviceQuery = {
  feedingAdvice: {
    tankId: string;
    recommendedAmount: number;
    feedType: string;
...
export type MessagesSinceQuery = {
  messagesSince: Array<{
    id: string;
    channelId: string;
    senderId: string;
...
export type DirectChannelQuery = {
  directChannel: {
    id: string;
    type: ChannelType;
    name: string | null;
...
export type AvailableAiPersonasQuery = {
  availableAiPersonas: Array<{
    id: string | null;
    name: string;
    description: string;
    icon: string;
...
export type UpdateNotificationPreferenceMutation = {
  updateNotificationPreference: { id: string; notificationPreference: NotificationPreference };
};
...
export type RequestMediaUploadMutation = {
  requestMediaUpload: { uploadUrl: string; storageKey: string; expiresAt: string };
};
...
export type GetTanksWithBatchesQuery = {
  tanks: {
    total: number;
    items: Array<{
      id: string;
...
export type RecordMortalityMutation = {
  recordMortality: {
    id: string;
    batchNumber: string;
...
export type RecordCullMutation = {
  recordCull: {
    id: string;
    batchNumber: string;
    currentQuantity: number;
...
export type CreateHarvestRecordMutation = {
  createHarvestRecord: {
    id: string;
    recordCode: string;
    lotNumber: string;
...
export type TodaysFeedingPlanQuery = {
  dailyFeedingExecutions: Array<{
    id: string;
    equipmentId: string;
...
export type RecordDailyFeedingMutation = {
  recordDailyFeeding: {
    id: string;
    actualFeedKg: number | null;
    status: ExecutionStatus;
...
export type MyAttendanceRecordsQuery = {
...
export type MyTodaysAttendanceQuery = {
  myTodaysAttendance: Array<{
    id: string;
    employeeId: string;
    date: string;
    clockIn: string | null;
...
export type MyLeaveBalancesQuery = {
...
export type SubmitLeaveRequestMutation = {
  submitLeaveRequest: { id: string; status: LeaveRequestStatus };
};
...
export type CancelLeaveRequestMutation = {
  cancelLeaveRequest: { id: string; status: LeaveRequestStatus };
};
...
export type GetTodaysTasksQuery = {
  todaysTasks: Array<{
    id: string;
    title: string;
    category: TaskCategory;
...
export type SetChecklistItemMutation = {
  setChecklistItem: { id: string; checklistItems: Record<string, unknown> | null };
};
...
export type AddTaskNoteMutation = {
  addTaskNote: { id: string; notes: Record<string, unknown> | null };
};
...
export type GetTodaysDailyOpsCountsQuery = {
...
export type GetStockEventsSummaryQuery = {
  stockEventsSummary: {
...
export type GetWarehouseSummaryQuery = {
  warehouseSummary: {
    totalItems: number;
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'forwardedFrom' } },
          ...
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'reactionSummary' },
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'aiPersona' } },
          { kind: 'Field', name: { kind: 'Name', value: 'aiServiceUrl' } },
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'memberCount' } },
          {
            ...
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                { kind: 'FragmentSpread', name: { kind: 'Name', value: 'MessageFields' } },
              ],
            },
          },
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'notificationPreference' } },
...
export const FarmDashboardInsightsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'FarmDashboardInsights' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            ...
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'overallRiskScore' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'tankRisks' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'tankId' } },
                ...
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: 'Field', name: { kind: 'Name', value: 'description' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'affectedEntity' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'suggestedActions' } },
                    ],
                  },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'feedingAdvice' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'tankId' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'recommendedAmount' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'feedType' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'feedingFrequency' } },
...
} as unknown as DocumentNode<FarmDashboardInsightsQuery, FarmDashboardInsightsQueryVariables>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'TankRiskAssessment' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'tankId' } },
          type: {
            kind: 'NonNullType',
        ...
        selections: [
          {
            ...
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'tankId' },
                value: { kind: 'Variable', name: { kind: 'Name', value: 'tankId' } },
              },
            ],
            selectionSet: {
              kind: 'SelectionSet',
...
} as unknown as DocumentNode<TankRiskAssessmentQuery, TankRiskAssessmentQueryVariables>;
export const BatchGrowthPredictionDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'BatchGrowthPrediction' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'currentAvgWeight' } },
                { kind: 'Field', name: { kind: 'Name', value: 'predictedAvgWeight30d' } },
                { kind: 'Field', name: { kind: 'Name', value: 'predictedSGR' } },
                { kind: 'Field', name: { kind: 'Name', value: 'predictedFCR' } },
                { kind: 'Field', name: { kind: 'Name', value: 'estimatedBiomass30d' } },
              ],
            },
          },
        ],
...
} as unknown as DocumentNode<BatchGrowthPredictionQuery, BatchGrowthPredictionQueryVariables>;
...
} as unknown as DocumentNode<FeedingAdviceQuery, FeedingAdviceQueryVariables>;
...
export const MyChannelsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'MyChannels' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'filter' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'ChannelFilterInput' } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
...
} as unknown as DocumentNode<MyChannelsQuery, MyChannelsQueryVariables>;
...
export const MessagesSinceDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'MessagesSince' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'channelId' } },
...
} as unknown as DocumentNode<MessagesSinceQuery, MessagesSinceQueryVariables>;
export const AllMessagesSinceDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      ...
      variableDefinitions: [
        ...
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'syncToken' } },
...
} as unknown as DocumentNode<AllMessagesSinceQuery, AllMessagesSinceQueryVariables>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'TotalUnreadMessageCount' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [{ kind: 'Field', name: { kind: 'Name', value: 'totalUnreadMessageCount' } }],
      },
    },
  ],
} as unknown as DocumentNode<TotalUnreadMessageCountQuery, TotalUnreadMessageCountQueryVariables>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'SearchMessagesInput' } },
          },
        },
      ],
      selectionSet: {
...
export const GetPinnedMessagesDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetPinnedMessages' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'channelId' } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                { kind: 'Field', name: { kind: 'Name', value: 'channelId' } },
                { kind: 'Field', name: { kind: 'Name', value: 'pinnedBy' } },
...
} as unknown as DocumentNode<GetPinnedMessagesQuery, GetPinnedMessagesQueryVariables>;
export const UserPresenceDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'UserPresence' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
...
} as unknown as DocumentNode<UserPresenceQuery, UserPresenceQueryVariables>;
export const DirectChannelDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'DirectChannel' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
...
} as unknown as DocumentNode<DirectChannelQuery, DirectChannelQueryVariables>;
export const AvailableAiPersonasDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'AvailableAiPersonas' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<AvailableAiPersonasQuery, AvailableAiPersonasQueryVariables>;
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'UpdateChannelInput' } },
          },
        },
      ],
      selectionSet: {
...
export const ArchiveChannelDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'ArchiveChannel' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<ArchiveChannelMutation, ArchiveChannelMutationVariables>;
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'ChannelMemberRole' } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
...
export const RemoveChannelMemberDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'RemoveChannelMember' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'channelId' } },
...
} as unknown as DocumentNode<RemoveChannelMemberMutation, RemoveChannelMemberMutationVariables>;
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'preference' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'NotificationPreference' } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              },
              {
                ...
                value: { kind: 'Variable', name: { kind: 'Name', value: 'preference' } },
              },
            ],
            selectionSet: {
              kind: 'SelectionSet',
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'EditMessageInput' } },
          },
        },
      ],
      selectionSet: {
...
export const MarkMessagesReadDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'MarkMessagesRead' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'MarkReadInput' } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<MarkMessagesReadMutation, MarkMessagesReadMutationVariables>;
export const RequestMediaUploadDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'RequestMediaUpload' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'RequestMediaUploadInput' } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<RequestMediaUploadMutation, RequestMediaUploadMutationVariables>;
export const PinMessageDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'PinMessage' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'channelId' } },
...
} as unknown as DocumentNode<PinMessageMutation, PinMessageMutationVariables>;
export const UnpinMessageDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'UnpinMessage' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'channelId' } },
...
} as unknown as DocumentNode<UnpinMessageMutation, UnpinMessageMutationVariables>;
...
export const ForwardMessageDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'ForwardMessage' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'sourceMessageId' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'ID' } },
          },
        ...
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'sourceMessageCreatedAt' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'DateTime' } },
          },
        ...
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'targetChannelId' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'ID' } },
          },
            ...
            arguments: [
              {
                ...
                value: { kind: 'Variable', name: { kind: 'Name', value: 'sourceMessageId' } },
              },
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'sourceMessageCreatedAt' },
                value: {
                  kind: 'Variable',
                  name: { kind: 'Name', value: 'sourceMessageCreatedAt' },
                },
              ...
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'targetChannelId' },
                value: { kind: 'Variable', name: { kind: 'Name', value: 'targetChannelId' } },
              },
            ],
            selectionSet: {
              kind: 'SelectionSet',
...
} as unknown as DocumentNode<ForwardMessageMutation, ForwardMessageMutationVariables>;
export const GetTanksWithBatchesDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetTanksWithBatches' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'tanks' },
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: 'Field', name: { kind: 'Name', value: 'status' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'currentBiomass' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'maxBiomass' } },
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'batchMetrics' },
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                            { kind: 'Field', name: { kind: 'Name', value: 'batchId' } },
                            ...
                            { kind: 'Field', name: { kind: 'Name', value: 'avgWeight' } },
                            { kind: 'Field', name: { kind: 'Name', value: 'biomass' } },
                            { kind: 'Field', name: { kind: 'Name', value: 'density' } },
                            { kind: 'Field', name: { kind: 'Name', value: 'capacityUsedPercent' } },
                            { kind: 'Field', name: { kind: 'Name', value: 'isOverCapacity' } },
                            { kind: 'Field', name: { kind: 'Name', value: 'daysSinceStocking' } },
                          ],
                        },
                      },
                    ],
...
} as unknown as DocumentNode<GetTanksWithBatchesQuery, GetTanksWithBatchesQueryVariables>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'RecordMortality' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'RecordMortalityInput' } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'totalMortality' } },
                { kind: 'Field', name: { kind: 'Name', value: 'retentionRate' } },
                { kind: 'Field', name: { kind: 'Name', value: 'mortalityRate' } },
              ],
            },
          },
        ],
...
} as unknown as DocumentNode<RecordMortalityMutation, RecordMortalityMutationVariables>;
export const RecordCullDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'RecordCull' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'RecordCullInput' } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'batchNumber' } },
                { kind: 'Field', name: { kind: 'Name', value: 'currentQuantity' } },
                { kind: 'Field', name: { kind: 'Name', value: 'cullCount' } },
                { kind: 'Field', name: { kind: 'Name', value: 'retentionRate' } },
              ],
            },
          },
...
} as unknown as DocumentNode<RecordCullMutation, RecordCullMutationVariables>;
export const CreateHarvestRecordDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'CreateHarvestRecord' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'CreateHarvestRecordInput' } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                { kind: 'Field', name: { kind: 'Name', value: 'recordCode' } },
                { kind: 'Field', name: { kind: 'Name', value: 'lotNumber' } },
                { kind: 'Field', name: { kind: 'Name', value: 'quantityHarvested' } },
                { kind: 'Field', name: { kind: 'Name', value: 'totalBiomass' } },
                { kind: 'Field', name: { kind: 'Name', value: 'averageWeight' } },
                { kind: 'Field', name: { kind: 'Name', value: 'qualityGrade' } },
                { kind: 'Field', name: { kind: 'Name', value: 'status' } },
              ],
            },
          },
...
} as unknown as DocumentNode<CreateHarvestRecordMutation, CreateHarvestRecordMutationVariables>;
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'dailyFeedingExecutions' },
            arguments: [
              {
                kind: 'Argument',
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'equipmentName' } },
                { kind: 'Field', name: { kind: 'Name', value: 'equipmentCode' } },
                { kind: 'Field', name: { kind: 'Name', value: 'calculations' } },
                { kind: 'Field', name: { kind: 'Name', value: 'plannedFeedKg' } },
                { kind: 'Field', name: { kind: 'Name', value: 'actualFeedKg' } },
                { kind: 'Field', name: { kind: 'Name', value: 'status' } },
                { kind: 'Field', name: { kind: 'Name', value: 'hasTransitionWarning' } },
              ],
            },
          },
        ],
...
} as unknown as DocumentNode<TodaysFeedingPlanQuery, TodaysFeedingPlanQueryVariables>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'RecordDailyFeeding' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'RecordDailyFeedingInput' } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'actualFeedKg' } },
                { kind: 'Field', name: { kind: 'Name', value: 'status' } },
                { kind: 'Field', name: { kind: 'Name', value: 'feedingMethod' } },
                { kind: 'Field', name: { kind: 'Name', value: 'feederName' } },
              ],
            },
          },
        ],
...
} as unknown as DocumentNode<RecordDailyFeedingMutation, RecordDailyFeedingMutationVariables>;
export const MyAttendanceRecordsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'MyAttendanceRecords' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'clockInMethod' } },
                { kind: 'Field', name: { kind: 'Name', value: 'clockOutMethod' } },
                { kind: 'Field', name: { kind: 'Name', value: 'status' } },
                { kind: 'Field', name: { kind: 'Name', value: 'workedMinutes' } },
                { kind: 'Field', name: { kind: 'Name', value: 'overtimeMinutes' } },
                { kind: 'Field', name: { kind: 'Name', value: 'lateMinutes' } },
                { kind: 'Field', name: { kind: 'Name', value: 'isOffshore' } },
                { kind: 'Field', name: { kind: 'Name', value: 'remarks' } },
                { kind: 'Field', name: { kind: 'Name', value: 'shiftId' } },
              ],
            },
          },
        ],
...
} as unknown as DocumentNode<MyAttendanceRecordsQuery, MyAttendanceRecordsQueryVariables>;
export const MyAttendanceSummaryDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: 'Field',
                  alias: { kind: 'Name', value: 'totalWorkingDays' },
                  name: { kind: 'Name', value: 'totalWorkDays' },
                },
                { kind: 'Field', name: { kind: 'Name', value: 'presentDays' } },
                { kind: 'Field', name: { kind: 'Name', value: 'absentDays' } },
                { kind: 'Field', name: { kind: 'Name', value: 'lateDays' } },
                { kind: 'Field', name: { kind: 'Name', value: 'leaveDays' } },
                { kind: 'Field', name: { kind: 'Name', value: 'totalWorkedMinutes' } },
                { kind: 'Field', name: { kind: 'Name', value: 'totalOvertimeMinutes' } },
                { kind: 'Field', name: { kind: 'Name', value: 'attendanceRate' } },
              ],
            },
          },
        ],
...
} as unknown as DocumentNode<MyAttendanceSummaryQuery, MyAttendanceSummaryQueryVariables>;
...
} as unknown as DocumentNode<MyTodaysAttendanceQuery, MyTodaysAttendanceQueryVariables>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'ClockInInput' } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<ClockInMutation, ClockInMutationVariables>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'ClockOutInput' } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<ClockOutMutation, ClockOutMutationVariables>;
export const MyLeaveRequestsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'MyLeaveRequests' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'status' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'LeaveRequestStatus' } },
        },
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'limit' } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                { kind: 'Field', name: { kind: 'Name', value: 'employeeId' } },
                { kind: 'Field', name: { kind: 'Name', value: 'leaveTypeId' } },
                {
                  kind: 'Field',
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'isHalfDayStart' } },
                { kind: 'Field', name: { kind: 'Name', value: 'isHalfDayEnd' } },
                { kind: 'Field', name: { kind: 'Name', value: 'halfDayPeriod' } },
...
} as unknown as DocumentNode<MyLeaveRequestsQuery, MyLeaveRequestsQueryVariables>;
export const MyLeaveBalancesDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'MyLeaveBalances' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'year' } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  alias: { kind: 'Name', value: 'totalEntitlement' },
                  name: { kind: 'Name', value: 'currentBalance' },
                },
                {
                  kind: 'Field',
                  alias: { kind: 'Name', value: 'usedDays' },
                  name: { kind: 'Name', value: 'used' },
                },
                {
                  kind: 'Field',
                  alias: { kind: 'Name', value: 'pendingDays' },
                  name: { kind: 'Name', value: 'pending' },
                },
                {
                  kind: 'Field',
                  alias: { kind: 'Name', value: 'remainingDays' },
...
} as unknown as DocumentNode<MyLeaveBalancesQuery, MyLeaveBalancesQueryVariables>;
export const LeaveTypesDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'LeaveTypes' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'defaultDaysPerYear' } },
                { kind: 'Field', name: { kind: 'Name', value: 'color' } },
              ],
            },
          },
...
} as unknown as DocumentNode<LeaveTypesQuery, LeaveTypesQueryVariables>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'CreateLeaveRequestInput' } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<CreateLeaveRequestMutation, CreateLeaveRequestMutationVariables>;
export const SubmitLeaveRequestDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'SubmitLeaveRequest' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<SubmitLeaveRequestMutation, SubmitLeaveRequestMutationVariables>;
export const CancelLeaveRequestDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'CancelLeaveRequest' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<CancelLeaveRequestMutation, CancelLeaveRequestMutationVariables>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'dueTime' } },
                { kind: 'Field', name: { kind: 'Name', value: 'location' } },
                { kind: 'Field', name: { kind: 'Name', value: 'estimatedMinutes' } },
                { kind: 'Field', name: { kind: 'Name', value: 'checklistItems' } },
...
export const GetTodaysTasksDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetTodaysTasks' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'todaysTasks' },
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<GetTodaysTasksQuery, GetTodaysTasksQueryVariables>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'tags' } },
                { kind: 'Field', name: { kind: 'Name', value: 'isRecurring' } },
                { kind: 'Field', name: { kind: 'Name', value: 'recurringTemplateId' } },
...
export const GetTaskStatsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'taskStats' },
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'totalToday' } },
                { kind: 'Field', name: { kind: 'Name', value: 'completedToday' } },
                { kind: 'Field', name: { kind: 'Name', value: 'overdueCount' } },
                { kind: 'Field', name: { kind: 'Name', value: 'upcomingCount' } },
                { kind: 'Field', name: { kind: 'Name', value: 'completionRate' } },
                { kind: 'Field', name: { kind: 'Name', value: 'avgCompletionMinutes' } },
              ],
            },
          },
        ],
...
} as unknown as DocumentNode<GetTaskStatsQuery, GetTaskStatsQueryVariables>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'TaskLifecycleInput' } },
          },
        },
      ],
      selectionSet: {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'StartTask' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
...
} as unknown as DocumentNode<StartTaskMutation, StartTaskMutationVariables>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'SetChecklistItem' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'SetChecklistItemInput' } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<SetChecklistItemMutation, SetChecklistItemMutationVariables>;
...
} as unknown as DocumentNode<GetMyNotificationsQuery, GetMyNotificationsQueryVariables>;
...
export const RecordTransferDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'RecordTransfer' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'TransferBatchInput' } },
          },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'transferBatch' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'input' },
...
} as unknown as DocumentNode<RecordTransferMutation, RecordTransferMutationVariables>;
export const GetTodaysDailyOpsCountsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetTodaysDailyOpsCounts' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'clientDate' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'todaysDailyOpsCounts' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'clientDate' },
                value: { kind: 'Variable', name: { kind: 'Name', value: 'clientDate' } },
              },
            ],
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'mortalityCount' } },
                { kind: 'Field', name: { kind: 'Name', value: 'wqReadingsCount' } },
                { kind: 'Field', name: { kind: 'Name', value: 'feedingCompletedCount' } },
                { kind: 'Field', name: { kind: 'Name', value: 'feedingTotalCount' } },
              ],
            },
          },
        ],
...
} as unknown as DocumentNode<GetTodaysDailyOpsCountsQuery, GetTodaysDailyOpsCountsQueryVariables>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetStockEventsSummary' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'daysBack' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'Int' } },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'stockEventsSummary' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'daysBack' },
                value: { kind: 'Variable', name: { kind: 'Name', value: 'daysBack' } },
              },
            ],
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'thisWeekEventsCount' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'recentEvents' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'type' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'tankName' } },
...
} as unknown as DocumentNode<GetStockEventsSummaryQuery, GetStockEventsSummaryQueryVariables>;
export const GetWarehouseSummaryDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetWarehouseSummary' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'lowStockAlertCount' } },
                { kind: 'Field', name: { kind: 'Name', value: 'todaysMovementCount' } },
                {
                  kind: 'Field',
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: 'Field', name: { kind: 'Name', value: 'currentQty' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'minQty' } },
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'recentMovements' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'movementType' } },
...
} as unknown as DocumentNode<GetWarehouseSummaryQuery, GetWarehouseSummaryQueryVariables>;
