...
interface CleanWaterTankNodeData extends Record<string, unknown> {
  label?: string;
  leftType?: HandleType;
...
const CleanWaterTankNode: React.FC<NodeProps<Node<CleanWaterTankNodeData>>> = ({ id, data, selected }) => {
