        ...
        <div className="relative w-full max-w-3xl bg-white rounded-lg shadow-xl" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
            <div>
              ...
              <p className="text-sm text-gray-500">Configure settings for regulatory report submission</p>
            </div>
            <button
              onClick={onClose}
          ...
          {/* Modal Content */}
          <div className="px-6 py-4 max-h-[calc(100vh-12rem)] overflow-y-auto space-y-6">
            {isLoading ? (
              ...
              <>
                  ...
                  <div className={`rounded-lg p-4 ${statusData.isFullyConfigured ? 'bg-green-50 border border-green-200' : 'bg-yellow-50 border border-yellow-200'}`}>
                    <div className="flex items-center">
                      ...
                      <span className={`font-medium ${statusData.isFullyConfigured ? 'text-green-800' : 'text-yellow-800'}`}>
                        {statusData.isFullyConfigured ? 'Report settings are fully configured' : 'Some report settings need attention'}
                      </span>
                    </div>
                    <div className="mt-2 flex flex-wrap gap-3 text-sm">
                      ...
                      <StatusBadge label="Slaughter Approval" configured={statusData.hasSlaughterApproval} />
                    </div>
                  </div>
                )}
                ...
                {/* Default Contact */}
                <div className="border border-gray-200 rounded-lg p-4">
                  <h3 className="text-base font-semibold text-gray-900 mb-3">Default Contact for Reports</h3>
                  <p className="text-sm text-gray-600 mb-4">
