...
const CRON_FILE = join(ROOT, 'apps/farm-service/src/feeding/services/feeding-cron.service.ts');
const SCHEDULER_FILE = join(ROOT, 'apps/farm-service/src/scheduler/feeding-scheduler.service.ts');
