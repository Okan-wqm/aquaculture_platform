    ...
    <div>
      <div className="flex flex-col sm:flex-row gap-4 mb-6">
        <div className="relative flex-1 max-w-md">
          <input type="text" placeholder="Search healthcare products..." value={searchTerm}
      ...
      {error && (
        <div className="text-center py-12 bg-red-50 rounded-lg border border-red-200">
          <p className="text-red-600">Failed to load healthcare stock.</p>
      ...
      {!isLoading && !error && (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          ...
          {filtered.length === 0 && (
            <div className="text-center py-12 text-gray-500 text-sm">No healthcare stock items found.</div>
          )}
        </div>
      )}
    </div>
