...
/** Authoritative server-side gate for future Marine CQRS/provider paths. */
@Injectable()
export class MarineExplorerFeatureGate {
  private readonly logger = new Logger(MarineExplorerFeatureGate.name);
