...
const STATUS_CONFIG: Record<string, { bg: string; text: string; label: string }> = {
  ACTIVE: {
    bg: 'bg-sea-100 dark:bg-sea-900/30',
      ...
      <div className="bg-gradient-to-r from-ocean-700 to-ocean-500 text-white">
        <div className="px-4 py-4 pt-safe-top">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span
              className={clsx('px-3 py-1 rounded-lg text-xs font-semibold', status.bg, status.text)}
            >
              {status.label}
            </span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 pb-2">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-center">
              <div className="text-xl font-bold">{tank.volume > 0 ? `${tank.volume}` : '--'}</div>
