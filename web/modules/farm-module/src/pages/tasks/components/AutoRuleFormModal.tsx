          ...
          <form onSubmit={handleSubmit}>
            <div className="px-6 pt-6 pb-4 border-b border-gray-200">
              <h3 className="text-lg font-semibold text-gray-900">
                {isEdit ? 'Kuralı Düzenle' : 'Yeni Otomatik Kural'}
              </h3>
              <p className="mt-1 text-sm text-gray-500">
                Koşul sağlandığında otomatik görev oluşturulacaktır.
              </p>
            </div>
            ...
            <div className="px-6 py-4 space-y-4">
              ...
              <div className="bg-blue-50 rounded-lg p-4 space-y-3">
                ...
                {/* Trigger Type */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Tetikleyici Tipi *</label>
                  <select
                    value={formData.trigger}
                    onChange={(e) => setFormData(prev => ({ ...prev, trigger: e.target.value as AutoRuleTrigger }))}
                ...
                {/* Trigger Condition */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Tetikleyici Koşul *</label>
                  <input
                    type="text"
              ...
              <div className="bg-green-50 rounded-lg p-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setFormData(prev => ({ ...prev, taskCategory: e.target.value as TaskCategory }))}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white"
                    >
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white"
                  >
                    <option value="">{users.length === 0 ? 'Yükleniyor...' : 'Seçin (opsiyonel)'}</option>
                    {users.map(u => (
