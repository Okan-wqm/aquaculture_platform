...
| `libs/configuration-contracts`  | libs/<domain>/ (cross-tier typed configuration contract SSoT)                                                                                                                   | config-service, backend-common runtime client, event-contracts, notification-service, billing-service, web/admin-panel                                                     |
