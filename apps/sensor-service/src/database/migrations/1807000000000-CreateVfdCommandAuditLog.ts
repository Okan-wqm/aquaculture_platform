...
export class CreateVfdCommandAuditLog1807000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    `);
    await queryRunner.query(`REVOKE UPDATE, DELETE ON sensor.vfd_command_audit_logs FROM PUBLIC`);
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX IF EXISTS sensor.idx_vfd_command_audit_tenant_device_time`);
