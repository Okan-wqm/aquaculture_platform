      ...
      footer={
        <>
          ...
          {task.status !== 'COMPLETED' && task.status !== 'CANCELLED' && (
            <Button variant="primary" onClick={() => onComplete(task.id)}>
              Tamamlandı
            </Button>
          )}
        </>
    ...
    >
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {task.isRecurring && (
            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-primary-100 dark:bg-primary-900/40 text-primary-800 dark:text-primary-200">
              Tekrarlayan
            </span>
          )}
          {task.isAutoGenerated && (
            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-accent-100 dark:bg-accent-900/40 text-accent-800 dark:text-accent-200">
              Otomatik
            </span>
          )}
        </div>
