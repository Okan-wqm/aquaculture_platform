...
export class AddTenantErasureRetainedColumns1804600000000
  implements MigrationInterface
{
  name = 'AddTenantErasureRetainedColumns1804600000000';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE ${TABLE} DROP COLUMN IF EXISTS "retainedRowsAnonymised"`,
    );
    await queryRunner.query(
      `ALTER TABLE ${TABLE} DROP COLUMN IF EXISTS "retainedRowsByTable"`,
    );
  }
}
