 ...
 *
 * TimescaleDB note: indexes are created on the hypertable root and
...
export class AddSensorMetricsCompositeIndex1740000000000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX CONCURRENTLY IF EXISTS "IDX_sensor_metrics_sensor_channel_time"`);
    await queryRunner.query(`DROP INDEX CONCURRENTLY IF EXISTS "IDX_sensor_metrics_tenant_sensor_channel_time"`);
  }
}
