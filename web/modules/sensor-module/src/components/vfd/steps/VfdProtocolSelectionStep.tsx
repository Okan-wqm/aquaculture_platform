...
export function VfdProtocolSelectionStep({
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-medium text-gray-900 mb-2">İletişim Protokolü Seçin</h3>
        <p className="text-sm text-gray-500">
          <span className="font-medium text-gray-700">{brand.name}</span> cihazınız için desteklenen
          iletişim protokollerinden birini seçin.
        </p>
      </div>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <div className="mt-2 flex items-center gap-3 text-xs">
                ...
                <span
                  className={`flex items-center px-2 py-1 bg-white rounded border border-blue-200 ${SPEED_LABELS[PROTOCOL_CONFIG[selectedProtocol]?.speed]?.color}`}
                >
