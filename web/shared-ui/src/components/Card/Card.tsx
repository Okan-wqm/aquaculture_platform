  ...
  return (
    ...
    >
      <div className="flex items-start justify-between">
        <div className="flex-1">
          ...
          {change !== undefined && (
            <p className={`mt-2 text-sm ${trendColors[trend]}`}>
              ...
              {/* trendLabel artık gerçekten render ediliyor (önceden bildirilmiş
                  ama kullanılmayan prop'tu); Türkçe varsayılan korunur. */}
        ...
        {icon && (
          <div className={`flex-shrink-0 p-3 rounded-lg ${iconClassName ?? 'bg-blue-50 text-blue-600'}`}>
            {icon}
          </div>
        )}
      </div>
