  ...
  return (
    ...
    >
      <g transform={`rotate(${rotation || 0} 70 50)`}>
        ...
        {/* Left tube sheet */}
        <line x1={35} y1={20} x2={35} y2={80} stroke={colors.stroke} strokeWidth={2} />

        {/* Right tube sheet */}
        <line x1={105} y1={20} x2={105} y2={80} stroke={colors.stroke} strokeWidth={2} />
        ...
        <line x1={0} y1={30} x2={20} y2={30} stroke={colors.stroke} strokeWidth={3} />
        {isRunning && (
          <polygon points="12,27 18,30 12,33" fill={themeColors.error[500]} opacity={0.8} />
        )}

        {/* Nozzle — hot-out (right-top) */}
        <line x1={120} y1={30} x2={140} y2={30} stroke={colors.stroke} strokeWidth={3} />
        {isRunning && (
