...
Status: RESOLVED for farm-module slice 1 (3 FE-over-select) + mcp/farm-management slice 2 (all 13) — baseline 130 → 114. Tracked for later: 2 farm sub-equipment `category` backend-gaps + the MCP date-filter input drift. Registry: orphan-findings.md + graphql-fe-drift.baseline.json.
