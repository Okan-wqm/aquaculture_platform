 ...
 *
 * Finding: docs/reviews/admin-expert/2026-09-05-superadmin-audit.md#INFRA-HIGH-166
 */
...
describe('admin-api production posture is stated in the droplet compose (INFRA-HIGH-166)', () => {
