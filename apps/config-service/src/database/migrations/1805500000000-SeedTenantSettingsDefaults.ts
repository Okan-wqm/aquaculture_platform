...
import { TENANT_SETTINGS, TENANT_SETTINGS_SERVICE } from '@platform/tenant-settings';
 ...
 *
 * Every row comes from `TENANT_SETTINGS` (the vocabulary the admin panel also
 * imports directly), so the seeded key set cannot drift from the
