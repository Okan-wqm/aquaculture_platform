  ...
  return (
    ...
    >
      <g transform={`rotate(${rotation || 0} 50 70)`}>
        ...
        {label && (
          <text x={50} y={138} textAnchor="middle" fontSize={8} fill={themeColors.neutral[700]} fontFamily="sans-serif">
            {label}
          </text>
        )}
      </g>

      <FaultOverlay state={state} viewBoxWidth={100} viewBoxHeight={140} />
      <MaintenanceOverlay state={state} viewBoxWidth={100} viewBoxHeight={140} />
