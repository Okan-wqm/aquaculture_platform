...
const CreateInvoiceModal: React.FC<CreateInvoiceModalProps> = ({ onSubmit, onClose }) => {
  ...
  return (
    ...
    >
      ...
      <div>
        <label htmlFor="invoice-tenant-id" className="block text-sm font-medium text-gray-700 mb-1">
          Tenant ID *
        </label>
        <input
      ...
      <div>
        <label htmlFor="invoice-street" className="block text-sm font-medium text-gray-700 mb-1">
          Street *
        </label>
        <input
          id="invoice-street"
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label htmlFor="invoice-city" className="block text-sm font-medium text-gray-700 mb-1">
            City *
          </label>
          <input
            id="invoice-city"
        ...
        <div>
          <label htmlFor="invoice-state" className="block text-sm font-medium text-gray-700 mb-1">
            State *
          </label>
          <input
            id="invoice-state"
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          <label htmlFor="invoice-country" className="block text-sm font-medium text-gray-700 mb-1">
            Country
          </label>
          <input
            id="invoice-country"
      ...
      <div>
        <label htmlFor="invoice-line-item" className="block text-sm font-medium text-gray-700 mb-1">
          Line Item *
        </label>
        <input
