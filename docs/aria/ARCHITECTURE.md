...
release_claim uses parse_release_reason; three exact native admission/execution/task-binding codes now map to harness fault domain beside retained legacy strings. Existing mappings and public signatures are preserved.
