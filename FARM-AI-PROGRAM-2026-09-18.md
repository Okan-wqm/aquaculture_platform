...
| Commit     | Delta                                                                                                                                                                                                                                                                                  |
| ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| a44db8004e | timestamp-uniqueness invariant (the ai collision was resolved on the canonical branch by renumbering the base branch's own AddZaiApiKey → 1803200000000; main's already-applied Heal keeps its name)                                                                                   |
