...
const UltrafiltrationNode: React.FC<NodeProps<Node<UltrafiltrationNodeData>>> = ({
  id,
  data,
  selected,
}) => {
  ...
  const [cleanWaterType, setCleanWaterType] = useState<HandleType>(
    data?.cleanWaterType || 'source',
  );
  ...
  return (
    ...
    >
      <svg width={width} height={height} viewBox="0 0 260 280" xmlns="http://www.w3.org/2000/svg">
        <defs>
        ...
        <text
          ...
          fontWeight="bold"
        >
          {t('scada.symbol.ultrafiltration')}
        </text>
        ...
        {/* Sinyal kablosu */}
        <path
          d="M 195 80 Q 180 80, 165 70 L 148 63"
        ...
        {/* Guc kablosu */}
        <path
          d="M 195 130 Q 180 130, 165 115 L 148 105"
