  ...
  return (
    <div className="flex items-center justify-between px-4 py-2 bg-white border-b border-gray-200 shadow-sm">
      ...
      <div className="flex items-center gap-3">
        ...
        />
        {isDirty && (
          <span className="text-xs text-yellow-600 bg-yellow-50 px-2 py-0.5 rounded">Unsaved</span>
        )}
        {saveSuccess && (
        ...
        {saveError && (
          <span className="text-xs text-red-600 bg-red-50 px-2 py-0.5 rounded">{saveError}</span>
        )}
      ...
      <div className="flex items-center gap-2">
        ...
        <div
          className="flex items-center bg-gray-100 rounded-lg p-0.5 border border-gray-200"
          role="radiogroup"
