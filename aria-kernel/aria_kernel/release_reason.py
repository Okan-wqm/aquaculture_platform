...
RELEASE_REASON_CODES: tuple[str, ...] = (
    ...
    "JUDGE_VERDICT_CONTRACT_VIOLATION", "SELF_CHANGE_CONTRACT_VIOLATION", "ADJUDICATION_CONTRACT_VIOLATION",
...
_LITERALS: dict[str, tuple[str, str]] = {
    ...
    "adjudication_contract_violation": ("ADJUDICATION_CONTRACT_VIOLATION", "harness"),
