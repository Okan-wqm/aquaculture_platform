      ...
      widgets: [
          ...
          animations: [
            {
              ...
              options: {
                ...
                fillWarningColor: colors.warning[500],
                fillCriticalColor: colors.error[500],
              },
            },
            {
              id: 'anim-ft-color',
          ...
          animations: [
            {
              ...
              options: {
                blinkInterval: 800,
                fillA: colors.error[50],
                fillB: colors.error[100],
                strokeA: colors.error[500],
                strokeB: colors.error[600],
              },
            },
            {
              id: 'anim-uv-color',
        ...
        // Top row: Fish Tank -> P1
        {
          ...
          config: {
            ...
            pipeColor: colors.gray[400],
            flowColor: colors.primary[300],
            pipeWidth: 10,
            flowSpeed: 0.6,
          },
          zIndex: 30,
        ...
        // ---- Status Indicators ----
        {
          ...
          config: {
            ...
            inactiveColor: colors.error[500],
            onLabel: 'RUN',
            offLabel: 'STOP',
          },
          zIndex: 60,
