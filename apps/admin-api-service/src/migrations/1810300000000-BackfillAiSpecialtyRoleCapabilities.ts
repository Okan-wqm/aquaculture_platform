...
/**
 * BackfillAiSpecialtyRoleCapabilities1810300000000 (RBAC-MEDIUM-016)
 *
...
export class BackfillAiSpecialtyRoleCapabilities1810300000000 implements MigrationInterface {
  name = 'BackfillAiSpecialtyRoleCapabilities1810300000000';
