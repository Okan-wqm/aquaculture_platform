...
const Glyph: React.FC<{ quality: TagQuality; className: string }> = ({ quality, className }) => {
  ...
  switch (quality) {
    ...
    case 'uncertain':
      return (
        <svg className={className} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
          <path fillRule="evenodd" d="M8.3 3.4c.8-1.3 2.6-1.3 3.4 0l5.8 10.1c.8 1.3-.2 3-1.7 3H4.2c-1.5 0-2.5-1.7-1.7-3L8.3 3.4zM10 7a1 1 0 011 1v3a1 1 0 11-2 0V8a1 1 0 011-1zm0 8a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" />
        </svg>
      );
    case 'bad':
    case 'comm_failure':
...
export const QualityIndicator: React.FC<QualityIndicatorProps> = ({ quality, label, showLabel = true, tone = 'text', size = 'sm', className = '' }) => {
