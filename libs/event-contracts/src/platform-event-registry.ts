...
export const PLATFORM_EVENT_REGISTRY = {
  ...
  NotificationSendEmail: {
    ...
    acl: { publish: ['platform-services'], subscribe: ['notification-service'] },
    piiClass: 'contact-ref',
    durability: 'request-reply-receipt',
    backendOnly: true,
  ...
  NotificationSendSms: {
    type: 'NotificationSendSms',
    kind: 'command',
    subject: NOTIFICATION_COMMAND_SUBJECTS.SEND_SMS,
    producer: 'platform-services',
    consumers: ['notification-service'],
    schema: 'libs/event-contracts/src/notification-commands.ts#NotificationSendSmsCommand',
    fixture: 'libs/event-contracts/fixtures/notification-send-sms-command.json',
    acl: { publish: ['platform-services'], subscribe: ['notification-service'] },
    piiClass: 'contact-ref',
    durability: 'request-reply-receipt',
    backendOnly: true,
  ...
  NotificationSendWebhook: {
    type: 'NotificationSendWebhook',
    kind: 'command',
    subject: NOTIFICATION_COMMAND_SUBJECTS.SEND_WEBHOOK,
    producer: 'platform-services',
    consumers: ['notification-service'],
    schema: 'libs/event-contracts/src/notification-commands.ts#NotificationSendWebhookCommand',
    fixture: 'libs/event-contracts/fixtures/notification-send-webhook-command.json',
    acl: { publish: ['platform-services'], subscribe: ['notification-service'] },
    piiClass: 'contact-ref',
    durability: 'request-reply-receipt',
    backendOnly: true,
