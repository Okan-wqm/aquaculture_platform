...
export function RecordTransferPage(): JSX.Element {
  ...
  // Binding it to the `TransferPayload` SSoT type makes excess-property checking
  ...
  // mirrors the buildPayload(): MortalityPayload / CullPayload pattern on the
  // mortality and cull pages.
  const buildPayload = (batchId: string): TransferPayload => ({
    batchId,
    sourceTankId,
    destinationTankId,
