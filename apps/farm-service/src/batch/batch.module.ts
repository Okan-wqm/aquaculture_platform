...
@Module({
  ...
  providers: [
    ...
    // P-31 gün içi recalc BURADA sağlanmaz: stok yazan handler'lar recalc'ı
    // artık kendileri çağırmıyor — TankBatchService.applyStockChange kapsamı
    // çağırıyor ve o servis TankBatchModule'den geliyor (tek bağlama noktası).
