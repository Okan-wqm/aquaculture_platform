...
> = {
  overdue: {
    ...
    icon: <TriangleAlert className="w-4 h-4 text-red-500" aria-hidden="true" />,
  },
  today: {
    label: 'Due today',
  ...
  urgent: {
    ...
    icon: <CircleAlert className="w-4 h-4 text-yellow-500" aria-hidden="true" />,
  },
  soon: {
    label: 'Coming up',
    bgColor: 'bg-blue-50',
  ...
  normal: {
    ...
    icon: <CircleCheck className="w-4 h-4 text-green-500" aria-hidden="true" />,
  },
  submitted: {
    label: 'Submitted',
