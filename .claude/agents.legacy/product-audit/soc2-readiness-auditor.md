...
> (`.claude/agents/compliance-expert.md`). SOC 2 + GDPR + KVKK
...
- Research: `docs/research/agents/product-audit/soc2-readiness-auditor/{YYYY-MM-DD}-{topic}.md`
...
- security readiness and evidence boundary docs:
  ...
  - `docs/research/agents/product-audit/2026-04-13-soc2-multi-tenant-microservices-readiness.md`
