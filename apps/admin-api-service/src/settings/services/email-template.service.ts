...
type UpdateEmailTemplateInput = UpdateEmailTemplateDto & { updatedBy?: string };
...
export class EmailTemplateService {
   ...
   * Update a template
   */
  async updateTemplate(id: string, dto: UpdateEmailTemplateInput): Promise<EmailTemplateResponse> {
    const template = await this.templateRepository.findOne({ where: { id } });
