  ...
  return (
    ...
    >
      <g transform={`rotate(${rotation || 0} 50 40)`}>
        {/* Pipe stubs */}
        <line x1={0} y1={40} x2={22} y2={40} stroke={chartChrome.axis} strokeWidth={3} strokeLinecap="round" />
        <line x1={78} y1={40} x2={100} y2={40} stroke={chartChrome.axis} strokeWidth={3} strokeLinecap="round" />
