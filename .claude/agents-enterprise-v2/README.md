...
W3 conversion wave (in-flight) brings remaining legacy-style agents (security-reviewer, orchestrator, implementation-planner, frontend-expert, platform-services, hr-expert, database-reviewer, context-manager, admin-expert, prompt-writer) under the ≤200-line SSoT-reference template (`_shared/_conversion-template.md`). Phase 1 of the abstract-brewing-mochi plan completes it.
