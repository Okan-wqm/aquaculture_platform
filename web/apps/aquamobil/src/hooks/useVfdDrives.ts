...
/**
 * DATA SOURCE (2026-09-17): MobileVfdFleet/MobileUnitDrives/feederSetup are
 * REAL GraphQL queries against the farm/sensor subgraphs — but the feeder
 * schema they need (feeder assignments, VFD calibration reshape) ships with
 * the aquamobil-v4 BACKEND (migrations 1808900000000+) which is merged in
 * the repo yet NOT yet deployed to this droplet's farm-service. Until that
 * deploy, these surfaces show their error/empty states by design — UNWIRED
 * in the running deployment, not mocked.
 */
