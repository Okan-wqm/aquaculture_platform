...
import { ArrowLeftRight, ChevronRight, Package, Scissors, Skull } from 'lucide-react';
    ...
    <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg overflow-hidden border border-gray-100 dark:border-gray-800">
      ...
      >
        ...
        <div className="flex items-center gap-2.5">
          ...
          <ChevronRight strokeWidth="2.5" className="text-white/75" size={16} aria-hidden="true" />
        </div>
      </button>
