  ...
  return (
    ...
    >
      ...
      <div className="p-4 space-y-5">
        ...
        {!isEditing && (
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Sensor Seçimi</label>
            {isLoading ? (
              <div className="p-3 text-center text-gray-500 text-sm">Sensörler yükleniyor...</div>
        ...
        {(selectedSensor || isEditing) && (
          <>
            {/* Custom Name */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Node Adı</label>
              <input
                type="text"
              ...
              {config.alarmsEnabled && (
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="block text-xs text-yellow-600 mb-1 font-medium">
                        Warning Low
                      </label>
                      <input
                        type="number"
