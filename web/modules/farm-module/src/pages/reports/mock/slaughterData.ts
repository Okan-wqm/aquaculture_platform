...
export const mockPlannedSlaughterReports: PlannedSlaughterReport[] = [
  // Current week - pending
  {
    ...
    kontaktperson: { navn: 'Erik Hansen', epost: 'erik.hansen@nordfjord.no', telefonnummer: '+47 123 45 678' },
    ...
    planlagteLokaliteter: [
      {
        ...
        slakteDato: nextWeek.toISOString(),
        batchId: 'batch-010',
        batchNumber: 'NF-2024-010',
      },
    ],
  ...
  // Previous week - submitted
  {
    ...
    organisasjonsnummer: '987654321',
    lokalitetsnummer: 31234,
    kontaktperson: { navn: 'Kari Olsen', epost: 'kari.olsen@nordfjord.no', telefonnummer: '+47 234 56 789' },
    godkjenningsnummer: 'H-001234',
    godkjenningsnavn: 'Marine Harvest Processing AS',
    planlagteLokaliteter: [
      {
...
export const mockExecutedSlaughterReports: ExecutedSlaughterReport[] = [
    ...
    utforteLokaliteter: [
      {
        ...
        slakteDato: weekAgo.toISOString(),
  ...
  // 2 weeks ago - approved
  {
    ...
    slakteaar: previousWeek > 1 ? previousWeekYear : previousWeekYear - 1,
    ...
    utforteLokaliteter: [
      {
        ...
        slakteDato: twoWeeksAgo.toISOString(),
      ...
      },
      {
        ...
        slakteDato: new Date(twoWeeksAgo.getTime() - 2 * 24 * 60 * 60 * 1000).toISOString(),
        kvalitetsgrad: 'Superior',
        batchId: 'batch-006',
        batchNumber: 'NF-2024-006',
        lotNumber: 'LOT-2025-NF-051',
