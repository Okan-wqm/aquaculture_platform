...
const ICON_PATHS: Record<string, readonly [string, string, string, string]> = {
  building:  ['M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z', 'M6 12H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2', 'M18 9h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-2', 'M10 6h4M10 10h4M10 14h4M10 18h4'],
  ...
  comms:     ['M14 9a2 2 0 0 1-2 2H6l-4 4V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2Z', 'M18 9h2a2 2 0 0 1 2 2v11l-4-4h-6a2 2 0 0 1-2-2v-1', '', ''],
  mail:      ['M22 7.5V18a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2Z', 'm2 7 10 7 10-7', '', ''],
  lifebuoy:  ['M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20Z', 'M16 12a4 4 0 1 0-8 0 4 4 0 0 0 8 0Z', 'm4.93 4.93 4.24 4.24m5.66 5.66 4.24 4.24', 'm14.83 9.17 4.24-4.24M4.93 19.07l4.24-4.24'],
  megaphone: ['m3 11 18-5v12L3 14v-3Z', 'M11.6 16.8a3 3 0 1 1-5.8-1.6', '', ''],
  drive:     ['M22 12H2', 'M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11Z', 'M6 16h.01M10 16h.01', ''],
  ...
  scroll:    ['M8 21h12a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H8', 'M2 3h6v16a2 2 0 0 1-4 0V5a2 2 0 0 0-2-2Z', 'M12 8h6M12 13h6', ''],
  ...
  droplet:   ['M7 16.3c2.2 0 4-1.83 4-4.05 0-1.16-.57-2.26-1.71-3.19S7.29 6.75 7 5.3c-.29 1.45-1.14 2.84-2.29 3.76S3 11.1 3 12.25c0 2.22 1.8 4.05 4 4.05Z', 'M12.56 6.6A10.97 10.97 0 0 0 14 3.02c.5 2.5 2 4.9 4 6.5s3 3.5 3 5.5a6.98 6.98 0 0 1-11.91 4.97', '', ''],
  wheat:     ['M2 22 16 8', 'M3.47 12.53 5 11l1.53 1.53a3.5 3.5 0 0 1 0 4.94L5 19l-1.53-1.53a3.5 3.5 0 0 1 0-4.94Z', 'M7.47 8.53 9 7l1.53 1.53a3.5 3.5 0 0 1 0 4.94L9 15l-1.53-1.53a3.5 3.5 0 0 1 0-4.94Z', 'M11.47 4.53 13 3l1.53 1.53a3.5 3.5 0 0 1 0 4.94L13 11l-1.53-1.53a3.5 3.5 0 0 1 0-4.94Z'],
  warehouse: ['M22 8.35V20a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8.35A2 2 0 0 1 3.26 6.5l8-3.2a2 2 0 0 1 1.48 0l8 3.2A2 2 0 0 1 22 8.35Z', 'M6 18h12', 'M6 14h12M6 10h12', ''],
  checks:    ['M11 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6', 'm9 11 3 3L22 4', '', ''],
  basket:    ['M2 11h20', 'm3.5 11 1.6 7.4a2 2 0 0 0 2 1.6h9.8a2 2 0 0 0 2-1.6l1.6-7.4', 'm5 11 4-7M19 11l-4-7', 'm9 15 .5 3M15 15l-.5 3'],
  bars:      ['M3 3v18h18', 'M18 17V9M13 17V5M8 17v-3', '', ''],
  signal:    ['M2 20h.01', 'M7 20v-4M12 20v-8M17 20V8M22 20V4', '', ''],
  chip:      ['M4 4h16v16H4Z', 'M9 9h6v6H9Z', 'M9 2v2M15 2v2M9 20v2M15 20v2', 'M2 9h2M2 15h2M20 9h2M20 15h2'],
  ...
  network:   ['M9 2h6v6H9Z', 'M2 16h6v6H2Z', 'M16 16h6v6h-6Z', 'M12 8v4M5 16v-2a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v2'],
  contact:   ['M4 4h16a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2Z', 'M16 2v2M8 2v2', 'M12 11a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z', 'M8 17a4 4 0 0 1 8 0'],
  calendar:  ['M3 6h18v16H3Z', 'M8 2v4M16 2v4M3 10h18', 'M8 14h.01M12 14h.01M16 14h.01', 'M8 18h.01M12 18h.01M16 18h.01'],
  ...
  report:    ['M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z', 'M14 2v6h6', 'M8 13h8M8 17h5', ''],
  repeat2:   ['m17 2 4 4-4 4', 'M3 11V9a4 4 0 0 1 4-4h14', 'm7 22-4-4 4-4', 'M21 13v2a4 4 0 0 1-4 4H3'],
  alert:     ['M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0Z', 'M12 9v4M12 17h.01', '', ''],
  expand:    ['M4 8V4h4M20 8V4h-4M4 16v4h4M20 16v4h-4', 'm4 4 5 5M20 4l-5 5M4 20l5-5M20 20l-5-5', '', ''],
    ...
    <div className="sd-rail-itemwrap">
      ...
      >
        ...
        {open && item.badge !== undefined && (
          <span className="sd-rail-meta">{item.badge}</span>
        )}
      ...
      {hasChildren && expanded && open && (
        <div className="sd-rail-children">
          {childItems.map((child) => (
            <RailChild key={child.id} item={child} activePath={activePath} onNavigate={onNavigate} userRoles={userRoles} />
          ))}
        </div>
      )}
    </div>
    ...
    >
      <div className="sd-rail-drawer">
        ...
        <div className="sd-rail-footer">
          ...
          {open && (
            <span className="sd-rail-status-text">{statusText ?? 'Live'}</span>
          )}
        </div>
      </div>
    </aside>
