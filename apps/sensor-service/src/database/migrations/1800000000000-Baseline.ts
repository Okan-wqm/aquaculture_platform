...
export class Baseline1800000000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_ce4ad1c5885cf09dc41939fda6" ON "sensor"."sensor_readings" ("pond_id", "timestamp") `);
        await queryRunner.query(`CREATE INDEX "IDX_79b6ae4cba75c33361355806d1" ON "sensor"."sensor_readings" ("tenant_id", "timestamp") `);
        await queryRunner.query(`CREATE INDEX "IDX_0376e08a5128b463a79a811084" ON "sensor"."sensor_readings" ("sensor_id", "timestamp") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_d2b6b856bd15cc7a861f6bbd3e" ON "sensor"."vfd_automation_rules" ("tenant_id", "is_active") `);
        await queryRunner.query(`CREATE TABLE "sensor"."device_group_members" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "group_id" uuid NOT NULL, "device_type" character varying(50) NOT NULL, "device_id" uuid NOT NULL, "added_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_b96457eddae4eea4154a529f7d0" UNIQUE ("group_id", "device_type", "device_id"), CONSTRAINT "PK_f61a3dd99cd0611ca2e5129d814" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_38edacdc737f29dac08a654ffa" ON "sensor"."device_group_members" ("device_type", "device_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_5339f23f8c7738cb721325e9fc" ON "sensor"."device_group_members" ("group_id") `);
        await queryRunner.query(`CREATE TABLE "sensor"."dashboard_layouts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenant_id" uuid NOT NULL, "user_id" character varying, "name" character varying NOT NULL, "description" text, "widgets" jsonb NOT NULL DEFAULT '[]', "process_background" jsonb, "grid_config" jsonb, "grid_version" integer NOT NULL DEFAULT '1', "is_default" boolean NOT NULL DEFAULT false, "is_system_default" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "created_by" character varying, CONSTRAINT "PK_1850c429674a715d8cb13769efb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_3b7f748d773955029ad513813e" ON "sensor"."dashboard_layouts" ("tenant_id", "is_system_default") `);
        await queryRunner.query(`CREATE INDEX "IDX_f06137059bd217d4ca8d1651b2" ON "sensor"."dashboard_layouts" ("tenant_id", "user_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_4d2e060d5baf921e764757d3d4" ON "sensor"."dashboard_layouts" ("tenant_id") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sensor"."lora_devices" DROP CONSTRAINT "FK_48860297d0c89ac5f304c5d35c2"`);
        await queryRunner.query(`ALTER TABLE "sensor"."feeding_parameters" DROP CONSTRAINT "FK_da3226dde7ffaa0fa19a05e9c1a"`);
        await queryRunner.query(`ALTER TABLE "sensor"."vfd_readings" DROP CONSTRAINT "FK_fbdeb2c3e706814795870612d1e"`);
        await queryRunner.query(`ALTER TABLE "sensor"."vfd_change_set_items" DROP CONSTRAINT "FK_8d7b4c9c9f012299a04dd4f9801"`);
        await queryRunner.query(`ALTER TABLE "sensor"."channel_detection_log" DROP CONSTRAINT "FK_6f62be38cd349f88bb30ed5759e"`);
        await queryRunner.query(`ALTER TABLE "sensor"."sensor_metrics" DROP CONSTRAINT "FK_6a1def793766bdc6883a231b1b6"`);
        await queryRunner.query(`ALTER TABLE "sensor"."sensor_metrics" DROP CONSTRAINT "FK_a41376bfe12979a7c4510892787"`);
        await queryRunner.query(`ALTER TABLE "sensor"."sensor_data_channels" DROP CONSTRAINT "FK_fe6f0c27169af47a4371c0efebb"`);
        await queryRunner.query(`ALTER TABLE "sensor"."sensors" DROP CONSTRAINT "FK_0c9c45d8d0283ebee985bd76581"`);
        await queryRunner.query(`ALTER TABLE "sensor"."sensors" DROP CONSTRAINT "FK_c42163c44980c1171f186d36655"`);
        await queryRunner.query(`ALTER TABLE "sensor"."sensors" DROP CONSTRAINT "FK_662ff86473e2a4fbc892c3463b2"`);
