...
export class CreateFeedingDayPlanAndMeals1806400000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "feeding_records" ADD COLUMN IF NOT EXISTS "mealId" uuid`);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "feeding_records" DROP COLUMN IF EXISTS "sourceExecutionId"`,
    );
