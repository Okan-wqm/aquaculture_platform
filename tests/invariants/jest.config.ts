  ...
  projects: [
    {
      ...
      testMatch: [
        ...
        '<rootDir>/platform-binary-installer-authority.spec.ts',
        ...
        '<rootDir>/droplet-capacity-control-plane.spec.ts',
        '<rootDir>/production-current-release-marker.spec.ts',
        '<rootDir>/production-host-runtime-bundle.spec.ts',
        '<rootDir>/production-host-control-plane-runtime.spec.ts',
        '<rootDir>/production-host-ssh-payload.spec.ts',
        ...
        '<rootDir>/production-cert-identity-store.spec.ts',
