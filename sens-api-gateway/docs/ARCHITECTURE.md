...
Current release contract: `agent-v2.0.0-rc4` with Cargo release tier `scada-display`.
This architecture document describes the agent capabilities; ADR-025-aligned Edge Platform v2 schema/runtime migration is follow-up work and is not part of the RC4 release-contract PR.
