...
| Frontend Form/Action | GraphQL Mutation | Backend Resolver | DB Table | Status |
|---|---|---|---|---|
| Sync Weather Data | `syncWeatherData` | `weather.resolver.ts` | `weather_observations`, `marine_observations` | VERIFIED |
| Update Weather Settings | `updateWeatherSettings` | `weather.resolver.ts` | `weather_settings` | VERIFIED |
...
| Frontend Form/Action | GraphQL Mutation | Backend Resolver | DB Table | Status |
|---|---|---|---|---|
| Save SentinelHub Settings | `saveSentinelHubSettings` | `sentinel-hub.resolver.ts` | `sentinel_hub_settings` | VERIFIED |
| Delete SentinelHub Settings | `deleteSentinelHubSettings` | `sentinel-hub.resolver.ts` | `sentinel_hub_settings` | VERIFIED |
