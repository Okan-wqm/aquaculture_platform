---
name: tenant-cost-attribution-agent
...
See `@.claude/agents-enterprise-v2/_shared/operating-modes.md`. CATCHER default; TEACHER outputs on "how to add cost labelling to my service" cite the cost-metric-family pattern above.
