 ...
 * contract for manual / GraphQL-driven movements: open a transaction and
 * delegate to the sole mutation authority. That authority enqueues durable
 * movement and threshold facts on the same transaction manager.
 *
