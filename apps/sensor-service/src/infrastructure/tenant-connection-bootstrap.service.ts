 ...
 * Those QueryRunners use the default search_path (sensor, public), so all queries
...
export class TenantConnectionBootstrap implements OnModuleInit {
  ...
  private readonly SOURCE_SCHEMA = 'sensor';
      ...
      if (typeof callback === 'function') {
        return originalConnect((err: any, client: any, done: any) => {
          ...
          try {
            ...
            // Not in request context (migrations, cron jobs, MQTT ingestion)
          }
