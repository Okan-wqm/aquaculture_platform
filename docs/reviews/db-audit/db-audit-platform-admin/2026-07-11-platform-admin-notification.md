...
### admin.plan_definitions,plan_module_assignments,custom_plans — writer FE-FORM · REST · admin-panel/Billing · **SUSPECT/OK** (FE `billing.ts` PlanDefinition/CustomPlan read; entity bodies not opened; plan_* unregistered → MEDIUM-002).
