...
async function fillStages(values: { adult: string; mobile: string; attached: string }): Promise<void> {
  await flushAct(() => {
...
describe('LiceCountPage — RecordLiceCountInput contract (FARM-HIGH-214)', { timeout: 20000 }, () => {
