 ...
 * ============================================================================
 *
 * Restores the two-trigger append-only contract on `farm.farm_audit_logs` that the
 ...
 */
export class RestoreAuditImmutabilityContract1806900000000 implements MigrationInterface {
  name = 'RestoreAuditImmutabilityContract1806900000000';

  public async up(queryRunner: QueryRunner): Promise<void> {
    for (const table of [{ schema: 'farm', table: 'farm_audit_logs' }]) {
