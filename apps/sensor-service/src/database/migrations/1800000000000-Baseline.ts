...
export class Baseline1800000000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "sensor"."sensor_protocols_category_enum" AS ENUM('industrial', 'iot', 'serial', 'wireless')`);
        await queryRunner.query(`CREATE TYPE "sensor"."sensor_protocols_subcategory_enum" AS ENUM('modbus', 'fieldbus', 'ethernet_industrial', 'plc_native', 'plc', 'building_automation', 'realtime_ethernet', 'message_queue', 'request_response', 'realtime', 'wired_serial', 'socket', 'bus', 'serial_port', 'network', 'lpwan', 'mesh', 'short_range')`);
        await queryRunner.query(`CREATE TYPE "sensor"."sensor_protocols_connectiontype_enum" AS ENUM('tcp', 'udp', 'serial', 'usb', 'wireless', 'hybrid', 'ethernet', 'i2c', 'one_wire', 'spi', 'bluetooth')`);
        ...
        await queryRunner.query(`CREATE TYPE "sensor"."sensors_type_enum" AS ENUM('temperature', 'ph', 'dissolved_oxygen', 'salinity', 'ammonia', 'nitrite', 'nitrate', 'turbidity', 'water_level', 'multi_parameter', 'flow_rate', 'conductivity', 'orp', 'chlorine', 'co2')`);
        await queryRunner.query(`CREATE TYPE "sensor"."sensors_status_enum" AS ENUM('active', 'inactive', 'maintenance', 'error', 'offline')`);
        await queryRunner.query(`CREATE TYPE "sensor"."sensors_registration_status_enum" AS ENUM('draft', 'pending_test', 'testing', 'test_failed', 'active', 'suspended')`);
        await queryRunner.query(`CREATE TYPE "sensor"."sensors_sensor_role_enum" AS ENUM('parent', 'child')`);
        ...
        await queryRunner.query(`CREATE TYPE "sensor"."sensor_data_channels_data_type_enum" AS ENUM('number', 'boolean', 'string', 'enum')`);
        await queryRunner.query(`CREATE TYPE "sensor"."sensor_data_channels_discovery_source_enum" AS ENUM('auto', 'manual', 'template')`);
        ...
        await queryRunner.query(`CREATE TYPE "sensor"."unified_tags_io_type_enum" AS ENUM('DI', 'DO', 'AI', 'AO')`);
        await queryRunner.query(`CREATE TYPE "sensor"."unified_tags_data_type_enum" AS ENUM('BOOL', 'INT16', 'INT32', 'UINT16', 'UINT32', 'FLOAT32', 'FLOAT64')`);
        await queryRunner.query(`CREATE TYPE "sensor"."unified_tags_direction_enum" AS ENUM('input', 'output', 'bidirectional')`);
        ...
        await queryRunner.query(`CREATE TYPE "sensor"."scada_packages_status_enum" AS ENUM('draft', 'published', 'archived')`);
        ...
        await queryRunner.query(`CREATE TYPE "sensor"."scada_deploy_logs_status_enum" AS ENUM('pending', 'sent', 'received', 'deploying', 'verifying', 'success', 'failed', 'rolled_back')`);
        ...
        await queryRunner.query(`CREATE TYPE "sensor"."processes_status_enum" AS ENUM('draft', 'active', 'inactive', 'archived')`);
        ...
        await queryRunner.query(`CREATE TYPE "sensor"."edge_devices_device_model_enum" AS ENUM('revolution_pi_connect_4', 'revolution_pi_compact', 'raspberry_pi_4', 'raspberry_pi_5', 'raspberry_pi_4_lora', 'raspberry_pi_5_lora', 'industrial_pc', 'custom')`);
        await queryRunner.query(`CREATE TYPE "sensor"."edge_devices_lifecycle_state_enum" AS ENUM('registered', 'provisioning', 'pending_approval', 'active', 'offline', 'maintenance', 'error', 'revoked', 'decommissioned')`);
        ...
        await queryRunner.query(`CREATE TYPE "sensor"."lora_devices_activation_mode_enum" AS ENUM('OTAA', 'ABP')`);
        await queryRunner.query(`CREATE TYPE "sensor"."lora_devices_device_class_enum" AS ENUM('A', 'B', 'C')`);
        ...
        await queryRunner.query(`CREATE TYPE "sensor"."device_io_configs_io_type_enum" AS ENUM('DI', 'DO', 'AI', 'AO')`);
        await queryRunner.query(`CREATE TYPE "sensor"."device_io_configs_data_type_enum" AS ENUM('bool', 'int16', 'int32', 'uint16', 'uint32', 'float32', 'float64')`);
        ...
        await queryRunner.query(`CREATE TYPE "sensor"."device_events_event_type_enum" AS ENUM('self_registered', 'approved', 'connected', 'disconnected', 'config_pushed', 'config_ack', 'deployment', 'reboot', 'error', 'alarm', 'heartbeat_lost', 'decommissioned')`);
        await queryRunner.query(`CREATE TYPE "sensor"."device_events_severity_enum" AS ENUM('info', 'warning', 'error', 'critical')`);
        ...
        await queryRunner.query(`CREATE TYPE "sensor"."program_variables_data_type_enum" AS ENUM('BOOL', 'INT', 'DINT', 'UINT', 'UDINT', 'REAL', 'LREAL', 'STRING', 'TIME', 'DATE', 'TOD', 'DT')`);
        await queryRunner.query(`CREATE TYPE "sensor"."program_variables_scope_enum" AS ENUM('local', 'input', 'output', 'inout', 'retain', 'constant')`);
        ...
        await queryRunner.query(`CREATE TYPE "sensor"."program_transitions_condition_type_enum" AS ENUM('expression', 'timeout', 'always', 'event')`);
        ...
        await queryRunner.query(`CREATE TYPE "sensor"."step_actions_qualifier_enum" AS ENUM('N', 'R', 'S', 'L', 'D', 'P', 'P0', 'P1', 'SD', 'DS', 'SL')`);
        await queryRunner.query(`CREATE TYPE "sensor"."step_actions_action_type_enum" AS ENUM('set_output', 'call_fb', 'assign', 'log', 'alarm', 'timer', 'custom_st')`);
        ...
        await queryRunner.query(`CREATE TYPE "sensor"."program_steps_step_type_enum" AS ENUM('initial', 'normal', 'final')`);
        await queryRunner.query(`CREATE TYPE "sensor"."program_steps_on_timeout_enum" AS ENUM('abort', 'skip', 'alarm', 'goto')`);
        ...
        await queryRunner.query(`CREATE TYPE "sensor"."deployment_logs_status_enum" AS ENUM('pending', 'deploying', 'success', 'failed', 'rolled_back')`);
        ...
        await queryRunner.query(`CREATE TYPE "sensor"."automation_programs_program_type_enum" AS ENUM('sfc', 'fbd', 'st', 'ld')`);
        await queryRunner.query(`CREATE TYPE "sensor"."automation_programs_execution_mode_enum" AS ENUM('manual', 'continuous', 'scheduled', 'triggered')`);
        await queryRunner.query(`CREATE TYPE "sensor"."automation_programs_status_enum" AS ENUM('draft', 'pending_review', 'approved', 'deploying', 'deployed', 'archived')`);
        await queryRunner.query(`CREATE TYPE "sensor"."automation_programs_deploy_target_enum" AS ENUM('rust_engine', 'codesys_plc', 'plc_setpoint')`);
