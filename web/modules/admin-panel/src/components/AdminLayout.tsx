  ...
  return (
    <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 lg:px-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="hidden md:block text-sm text-gray-500">Super Admin Panel</div>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3 pl-4 border-l border-gray-200">
          ...
          <button
            ...
            className="w-9 h-9 bg-blue-600 rounded-full flex items-center justify-center text-white font-medium"
          >
            SA
          </button>
        </div>
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <div className="hidden lg:block">
        <AdminNavSidebar collapsed={sidebarCollapsed} onCollapsedChange={setSidebarCollapsed} />
      </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <main id="main-content" className="flex-1 overflow-y-auto">
          <div className="p-4 lg:p-6 max-w-[1920px] mx-auto">{children || <Outlet />}</div>
        </main>
      </div>
    </div>
  );
