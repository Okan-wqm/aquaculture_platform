...
export const FishTankIcon: React.FC<IconProps> = ({
  size = 24,
  className = '',
  color = 'currentColor',
}) => (
...
export const RacewayIcon: React.FC<IconProps> = ({
  size = 24,
  className = '',
  color = 'currentColor',
}) => (
...
// Water Pump
export const WaterPumpIcon: React.FC<IconProps> = ({
  size = 24,
  className = '',
  color = 'currentColor',
}) => (
...
// Blower
export const BlowerIcon: React.FC<IconProps> = ({
  size = 24,
  className = '',
  color = 'currentColor',
}) => (
...
// Biofilter
export const BiofilterIcon: React.FC<IconProps> = ({
  size = 24,
  className = '',
  color = 'currentColor',
}) => (
...
// Auto Feeder
export const AutoFeederIcon: React.FC<IconProps> = ({
  size = 24,
  className = '',
  color = 'currentColor',
}) => (
...
// Aerator
export const AeratorIcon: React.FC<IconProps> = ({
  size = 24,
  className = '',
  color = 'currentColor',
}) => (
...
// Heat Exchanger
export const HeatExchangerIcon: React.FC<IconProps> = ({
  size = 24,
  className = '',
  color = 'currentColor',
}) => (
...
// UV Sterilizer
export const UVSterilizerIcon: React.FC<IconProps> = ({
  size = 24,
  className = '',
  color = 'currentColor',
}) => (
...
// Ozone Generator
export const OzoneGeneratorIcon: React.FC<IconProps> = ({
  size = 24,
  className = '',
  color = 'currentColor',
}) => (
  ...
  >
    ...
    <text x="12" y="12" textAnchor="middle" fontSize="6" fill={color}>
      O3
    </text>
    <path d="M8 16h8" />
    <path d="M10 18h4" />
...
export const MultiparameterProbeIcon: React.FC<IconProps> = ({
  size = 24,
  className = '',
  color = 'currentColor',
}) => (
...
export const DefaultEquipmentIcon: React.FC<IconProps> = ({
  size = 24,
  className = '',
  color = 'currentColor',
}) => (
...
export const getAllEquipmentIcons = () => {
  return [
    ...
    { code: 'chiller', name: 'Chiller', icon: ChillerIcon, category: 'heating_cooling' },
    {
      code: 'uv-sterilizer',
      name: 'UV Sterilizer',
      icon: UVSterilizerIcon,
      category: 'water_treatment',
    },
    {
      code: 'ozone-generator',
      name: 'Ozone Generator',
      icon: OzoneGeneratorIcon,
      category: 'water_treatment',
    },
    {
      code: 'multiparameter-probe',
      name: 'Multiparameter Probe',
      icon: MultiparameterProbeIcon,
      category: 'monitoring',
    },
  ];
};
