...
import type { StockMovementType, StorageItemType, StockMovementPayload } from '@/types';
...
export function StockMovementPage(): JSX.Element {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    const input: StockMovementPayload = {
      movementType,
      itemType,
    ...
    try {
      if (isOnline) {
        ...
        const queued = await addToQueue('recordStockMovement', input);
