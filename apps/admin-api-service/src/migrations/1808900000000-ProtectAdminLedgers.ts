 ...
 */
export class ProtectAdminLedgers1808900000000 implements MigrationInterface {
  name = 'ProtectAdminLedgers1808900000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      END $$;
    `);
    // -- COMPLIANCE-WAIVER: DATA-CRITICAL-015 archive flags are lifecycle state on a WORM ledger (ADR-0008); disposal belongs to the retention kernel (ADR-0012) -- DESTRUCTIVE: lifecycle flag, not evidence; rollback = none needed, no reader remains
    await queryRunner.query(
