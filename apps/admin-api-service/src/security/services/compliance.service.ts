...
import type {
  AdminComplianceCheckResultV1,
  AdminComplianceRequirementV1,
...
export type ComplianceRequirement = AdminComplianceRequirementV1;
export type ComplianceCheckResult = AdminComplianceCheckResultV1;
