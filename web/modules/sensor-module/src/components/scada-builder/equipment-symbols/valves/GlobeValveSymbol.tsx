  ...
  return (
    ...
    >
      <g transform={`rotate(${rotation || 0} 50 40)`}>
        ...
        <circle cx={50} cy={40} r={8} fill="none" stroke={colors.stroke} strokeWidth={1.5} />

        {/* Globe interior — horizontal seat line */}
        <line x1={42} y1={40} x2={58} y2={40} stroke={colors.stroke} strokeWidth={1.5} />
        ...
        <circle cx={50} cy={4} r={4} fill="none" stroke={colors.stroke} strokeWidth={2} />

        {/* Handwheel center */}
        <circle cx={50} cy={4} r={1.5} fill={colors.stroke} />
