...
- If the review scope itself is `.claude/agents/*.md` or `.claude/agents/*.md`, treat that as **agent-maintenance work**, not an application/runtime review cycle
...
| `.claude/agents/*.md`, `.claude/agents/*.md` | prompt-writer | maintenance-only; outside runtime review roster |
