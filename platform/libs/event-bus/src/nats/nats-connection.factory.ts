 ...
 * fallback across the connection and JetStream layers.
 *
 * The NATS transport adapter owns this factory. Higher-level application
 * infrastructure (`backend-common`) and direct NATS clients depend on this
 * transport port; the adapter never reaches back into those consumers.
 */
