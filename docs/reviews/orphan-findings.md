...
## ORPHAN-MEDIUM-300 — narrow autonomous-merge lane lacked a decision record, activation ceremony, and executable inactive-today proof — IN-PROGRESS
...
## ORPHAN-LOW-301 — git fixture repos spawn background auto-gc racing TemporaryDirectory cleanup — IN-PROGRESS
