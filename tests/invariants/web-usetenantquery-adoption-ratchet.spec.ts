 ...
 * 2026-06-29: 282 → 258 (useEdgeDevices, #722) → 220 (the sensor invalidation-key
 * cluster moved to createTenantInvalidationKey, see web-no-createtenantquerykey-in-invalidate).
 */
const BASELINE_CEILING = 220;
