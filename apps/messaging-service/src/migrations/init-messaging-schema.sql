...
--
-- Source-owned infrastructure only. This table lives in messaging.* and is
-- never cloned into tenant_<uuid> schemas. The canonical primary key is UUID
-- so outbox IDs can be used safely by distributed publishers and NATS Msg-Id
-- de-duplication without relying on a source-local sequence.
-- ============================================================================
