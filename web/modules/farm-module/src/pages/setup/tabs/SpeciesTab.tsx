...
export const SpeciesTab: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const message = err instanceof Error ? err.message : 'Failed to save species. Please try again.';
  ...
  const handleDelete = async (id: string) => {
    if (confirm('Are you sure you want to delete this species?')) {
      ...
      try {
        ...
        const message = err instanceof Error ? err.message : 'Failed to delete species. Please try again.';
      ...
      {deleteError && (
        <div className="mb-4 p-3 bg-red-50 border border-red-200 rounded-md">
          <div className="flex items-center justify-between">
            ...
            <button type="button" onClick={() => setDeleteError(null)} className="text-red-400 hover:text-red-600">
