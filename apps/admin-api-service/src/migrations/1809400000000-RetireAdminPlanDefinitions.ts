 ...
 * `discountPercent` of 400. `MergePlanCatalogue1802500000000` folded it into
 ...
 */
export class RetireAdminPlanDefinitions1809400000000 implements MigrationInterface {
  name = 'RetireAdminPlanDefinitions1809400000000';
    ...
    await queryRunner.query(`
      ...
      BEGIN
        ...
        IF to_regclass('billing.plan_cycle_prices') IS NULL THEN
          RAISE EXCEPTION
            'billing.plan_cycle_prices does not exist — run the billing migrations (MergePlanCatalogue1802500000000) before retiring admin.plan_definitions';
        END IF;
