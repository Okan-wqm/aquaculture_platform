...
## ORPHAN-MEDIUM-322 — migration-runner and security-event sinks build non-canonical subjects that NatsEventBus.normalizeSubject rejects; observability's consumers listen on `events.`-prefixed variants nothing could ever emit — IN-PROGRESS (this PR)
