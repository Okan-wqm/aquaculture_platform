...
export type GetTodaysDailyOpsCountsQueryVariables = Exact<{ [key: string]: never; }>;
...
export type GetStockEventsSummaryQuery = { stockEventsSummary: { thisWeekEventsCount: number, pendingTransferCount: number, recentEvents: Array<{ id: string, type: string, tankName: string, quantity: number, createdAt: string, note: string | null }> } };
