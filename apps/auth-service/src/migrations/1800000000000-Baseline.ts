...
export class Baseline1800000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_users_password_reset_token" ON "auth"."users" ("passwordResetToken") WHERE "passwordResetToken" IS NOT NULL`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_users_invitation_token" ON "auth"."users" ("invitationToken") WHERE "invitationToken" IS NOT NULL`,
    );
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_webauthn_credential_id" ON "auth"."webauthn_credentials" ("credentialId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_webauthn_user" ON "auth"."webauthn_credentials" ("userId") `,
    );
    await queryRunner.query(
      `CREATE TABLE "auth"."user_module_assignments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "moduleId" uuid NOT NULL, "tenantId" uuid NOT NULL, "isPrimaryManager" boolean NOT NULL DEFAULT false, "isActive" boolean NOT NULL DEFAULT true, "permissions" jsonb, "assignedBy" uuid NOT NULL, "expiresAt" TIMESTAMP WITH TIME ZONE, "notes" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_user_module" UNIQUE ("userId", "moduleId"), CONSTRAINT "PK_1894975bec32119992d4ca80a3c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_user_module_assignments_tenant" ON "auth"."user_module_assignments" ("tenantId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_user_module_assignments_module" ON "auth"."user_module_assignments" ("moduleId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_user_module_assignments_user" ON "auth"."user_module_assignments" ("userId") `,
    );
    await queryRunner.query(
      `CREATE TABLE "auth"."invitations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "token" character varying(128) NOT NULL, "email" character varying(255) NOT NULL, "firstName" character varying(100), "lastName" character varying(100), "role" character varying(50) NOT NULL, "tenantId" uuid, "moduleIds" text, "primaryModuleId" uuid, "status" character varying(20) NOT NULL DEFAULT 'PENDING', "expiresAt" TIMESTAMP WITH TIME ZONE NOT NULL, "acceptedAt" TIMESTAMP WITH TIME ZONE, "userId" uuid, "message" text, "invitedBy" uuid NOT NULL, "sendCount" integer NOT NULL DEFAULT '1', "lastSentAt" TIMESTAMP WITH TIME ZONE, "acceptedFromIp" character varying(50), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_e577dcf9bb6d084373ed3998509" UNIQUE ("token"), CONSTRAINT "PK_5dec98cfdfd562e4ad3648bbb07" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_invitations_status" ON "auth"."invitations" ("status") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_invitations_tenant" ON "auth"."invitations" ("tenantId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_invitations_email" ON "auth"."invitations" ("email") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_invitations_token" ON "auth"."invitations" ("token") `,
    );
    await queryRunner.query(
      `DO $$ BEGIN CREATE TYPE "auth"."announcements_type_enum" AS ENUM('info', 'warning', 'critical', 'maintenance'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;`,
    );
    await queryRunner.query(
      `DO $$ BEGIN CREATE TYPE "auth"."announcements_status_enum" AS ENUM('draft', 'scheduled', 'published', 'expired', 'cancelled'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;`,
    );
    await queryRunner.query(
      `DO $$ BEGIN CREATE TYPE "auth"."announcements_scope_enum" AS ENUM('platform', 'tenant'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;`,
    );
    await queryRunner.query(
      `CREATE TABLE "auth"."announcements" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "content" text NOT NULL, "type" "auth"."announcements_type_enum" NOT NULL DEFAULT 'info', "status" "auth"."announcements_status_enum" NOT NULL DEFAULT 'draft', "scope" "auth"."announcements_scope_enum" NOT NULL, "tenantId" uuid, "isGlobal" boolean NOT NULL DEFAULT true, "targetCriteria" jsonb, "publishAt" TIMESTAMP WITH TIME ZONE, "expiresAt" TIMESTAMP WITH TIME ZONE, "requiresAcknowledgment" boolean NOT NULL DEFAULT false, "viewCount" integer NOT NULL DEFAULT '0', "acknowledgmentCount" integer NOT NULL DEFAULT '0', "createdBy" uuid NOT NULL, "createdByName" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_b3ad760876ff2e19d58e05dc8b0" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_29f5be1631fdc08ce2ad6a9c03" ON "auth"."announcements" ("tenantId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_0fabf411618aba4c3c7790fd31" ON "auth"."announcements" ("publishAt") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_5f0c9af38fdf3318a0294dfb74" ON "auth"."announcements" ("tenantId", "status") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_6f68011926b37a4b428850b85a" ON "auth"."announcements" ("scope", "status") `,
    );
    await queryRunner.query(
      `CREATE TABLE "auth"."announcement_acknowledgments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "announcementId" uuid NOT NULL, "userId" uuid NOT NULL, "userName" character varying NOT NULL, "tenantId" uuid, "tenantName" character varying(255), "viewedAt" TIMESTAMP NOT NULL DEFAULT now(), "acknowledgedAt" TIMESTAMP WITH TIME ZONE, CONSTRAINT "UQ_28c0b4b7a87307b8e2aa7573af3" UNIQUE ("announcementId", "userId"), CONSTRAINT "PK_2210e80b68c3a16b3d5fcb5eec1" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_5b31e3f30a25937e045cfba3d6" ON "auth"."announcement_acknowledgments" ("announcementId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_ba4b92cd3ce9d8fe5fc560661d" ON "auth"."announcement_acknowledgments" ("userId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_81a16611785f2db0c09b6250ba" ON "auth"."announcement_acknowledgments" ("userId", "viewedAt") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_28c0b4b7a87307b8e2aa7573af" ON "auth"."announcement_acknowledgments" ("announcementId", "userId") `,
    );
    await queryRunner.query(
      `CREATE TABLE "auth"."refresh_tokens" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "token" character varying(255) NOT NULL, "userId" uuid NOT NULL, "tenantId" uuid, "expiresAt" TIMESTAMP WITH TIME ZONE NOT NULL, "isRevoked" boolean NOT NULL DEFAULT false, "mfaVerified" boolean NOT NULL DEFAULT false, "revokedAt" TIMESTAMP WITH TIME ZONE, "revokedReason" character varying(255), "userAgent" character varying(500), "ipAddress" character varying(50), "deviceId" character varying(100), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7d8bee0204106019488c4c50ffa" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_refresh_tokens_tenant" ON "auth"."refresh_tokens" ("tenantId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_refresh_tokens_expires" ON "auth"."refresh_tokens" ("expiresAt") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_refresh_tokens_token" ON "auth"."refresh_tokens" ("token") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_refresh_tokens_user_revoked" ON "auth"."refresh_tokens" ("userId", "isRevoked") `,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."tenant_modules" ADD CONSTRAINT "FK_54b5bb2fadb6ada4fe57a9e2701" FOREIGN KEY ("tenantId") REFERENCES "auth"."tenants"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."tenant_modules" ADD CONSTRAINT "FK_a001196031d22c837d0e45c450e" FOREIGN KEY ("moduleId") REFERENCES "auth"."modules"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."support_tickets" ADD CONSTRAINT "FK_7f39d4242941c82c75c939c7e0c" FOREIGN KEY ("tenantId") REFERENCES "auth"."tenants"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."ticket_comments" ADD CONSTRAINT "FK_f6beba8ae36e1ce20968d7a3192" FOREIGN KEY ("ticketId") REFERENCES "auth"."support_tickets"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."message_threads" ADD CONSTRAINT "FK_8bccdf9b34dc6b06fc2636856f4" FOREIGN KEY ("tenantId") REFERENCES "auth"."tenants"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."messages" ADD CONSTRAINT "FK_15f9bd2bf472ff12b6ee20012d0" FOREIGN KEY ("threadId") REFERENCES "auth"."message_threads"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."webauthn_credentials" ADD CONSTRAINT "FK_4e5d1a5131f49fdbc410b8ded04" FOREIGN KEY ("userId") REFERENCES "auth"."users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."user_module_assignments" ADD CONSTRAINT "FK_cdec674320f153ecf8e842cd443" FOREIGN KEY ("userId") REFERENCES "auth"."users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."user_module_assignments" ADD CONSTRAINT "FK_5d42a5b70f4506a9c29fb3bd225" FOREIGN KEY ("moduleId") REFERENCES "auth"."modules"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."announcements" ADD CONSTRAINT "FK_29f5be1631fdc08ce2ad6a9c034" FOREIGN KEY ("tenantId") REFERENCES "auth"."tenants"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."announcement_acknowledgments" ADD CONSTRAINT "FK_5b31e3f30a25937e045cfba3d6d" FOREIGN KEY ("announcementId") REFERENCES "auth"."announcements"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."refresh_tokens" ADD CONSTRAINT "FK_610102b60fea1455310ccd299de" FOREIGN KEY ("userId") REFERENCES "auth"."users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP FUNCTION IF EXISTS "auth".audit_logs_prevent_update_or_delete();`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."refresh_tokens" DROP CONSTRAINT "FK_610102b60fea1455310ccd299de"`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."announcement_acknowledgments" DROP CONSTRAINT "FK_5b31e3f30a25937e045cfba3d6d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."announcements" DROP CONSTRAINT "FK_29f5be1631fdc08ce2ad6a9c034"`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."user_module_assignments" DROP CONSTRAINT "FK_5d42a5b70f4506a9c29fb3bd225"`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."user_module_assignments" DROP CONSTRAINT "FK_cdec674320f153ecf8e842cd443"`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."webauthn_credentials" DROP CONSTRAINT "FK_4e5d1a5131f49fdbc410b8ded04"`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."messages" DROP CONSTRAINT "FK_15f9bd2bf472ff12b6ee20012d0"`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."message_threads" DROP CONSTRAINT "FK_8bccdf9b34dc6b06fc2636856f4"`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."ticket_comments" DROP CONSTRAINT "FK_f6beba8ae36e1ce20968d7a3192"`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."support_tickets" DROP CONSTRAINT "FK_7f39d4242941c82c75c939c7e0c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."tenant_modules" DROP CONSTRAINT "FK_a001196031d22c837d0e45c450e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "auth"."tenant_modules" DROP CONSTRAINT "FK_54b5bb2fadb6ada4fe57a9e2701"`,
    );
