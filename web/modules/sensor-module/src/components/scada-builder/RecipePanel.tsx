      ...
      {showNewForm && (
        <div className="p-3 bg-cyan-50 border border-cyan-200 rounded-lg space-y-2">
          <input
            ...
            className="w-full px-2 py-1.5 text-xs border border-gray-300 dark:border-gray-600 rounded focus:ring-1 focus:ring-cyan-500"
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-2 py-1.5 text-xs text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded"
            >
              Cancel
            </button>
          </div>
