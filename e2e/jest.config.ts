...
const config: Config = {
  ...
  moduleNameMapper: {
    ...
    '^@aquaculture/backend-common/database$':
      '<rootDir>/../libs/backend-common/src/database/index.ts',
    ...
    '^@aquaculture/backend-common/bootstrap$':
      '<rootDir>/../libs/backend-common/src/bootstrap/index.ts',
    '^@aquaculture/backend-common/config$': '<rootDir>/../libs/backend-common/src/config/index.ts',
    '^@aquaculture/backend-common/decorators$':
      '<rootDir>/../libs/backend-common/src/decorators/index.ts',
    '^@aquaculture/backend-common/security$':
      '<rootDir>/../libs/backend-common/src/security/index.ts',
    ...
    '^@platform/admin-http-contracts$':
      '<rootDir>/../platform/libs/admin-http-contracts/src/index.ts',
    '^@platform/pagination-contracts$':
      '<rootDir>/../platform/libs/pagination-contracts/src/index.ts',
