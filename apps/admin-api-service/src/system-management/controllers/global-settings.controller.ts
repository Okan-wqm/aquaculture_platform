...
import { UpdateProvisioningConfigDto } from '../dto/provisioning-config.dto';
import {
  FeatureToggleScope,
  FeatureToggleStatus,
  FeatureCondition,
...
export class GlobalSettingsController {
  ...
  updateProvisioningConfig(@Body() body: UpdateProvisioningConfigDto, @Req() req: Request): never {
