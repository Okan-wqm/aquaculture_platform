  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="px-4 mt-5">
        <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-3">Culled Fish Count</h3>
      ...
      {/* Reason Selector */}
      <div className="px-4 mt-5">
        <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-3">Cull Reason</h3>
          ...
          {CULL_REASONS.map((r) => (
            <button
              ...
              className={clsx(
                ...
                reason === r.value
                  ? 'border-cull bg-orange-50 dark:bg-orange-900/20 shadow-glow-orange'
