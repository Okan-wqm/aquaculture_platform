...
**Status:** PARTIAL_FIX in Batch #297 (registry entry ULTRA-HIGH-046, primitive landed). SignedStSource wire shape + canonical_bytes + verify_signed_st_source primitive in place; cmd_deploy_st_source MQTT handler + compile_and_deploy_signed_source adapter pending Batches #298+#299 per primitive-first batch discipline.
