...
exports.default = createRule({
    ...
    meta: {
        type: 'problem',
        docs: {
            description: 'A validated input DTO must not declare a field that names who acted; the actor comes from the verified request frame (ADMIN-CRITICAL-102).',
        },
        messages: {
            actorFromClient: "'{{name}}' names an actor. Input DTOs cannot claim who acted — the audit writer reads the principal the guard verified from the request frame. Remove the field; if the value is a filter, put it on a *QueryDto.",
        },
        schema: [],
    },
    defaultOptions: [],
